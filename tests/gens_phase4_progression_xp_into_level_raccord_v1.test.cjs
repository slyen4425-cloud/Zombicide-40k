...
assert.equal(indexBuf.length,8171879,'raccord RED must start from exact preaudit GREEN index');
assert.equal(gitBlob(indexBuf),'7601760f7a635094d4f687b725a639b5728e93b4','raccord RED index drifted');
