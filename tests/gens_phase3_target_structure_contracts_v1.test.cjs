...
assert.equal(Object.keys(ownerManifest.files||{}).length,73,'Phase 3 scaffolding must remain inert while the current Phase 4 production owner graph contains 73 files');
