...
assert.equal(indexBuf.length,8170402,'raccord guard must target current Dungeon S2 runtime size');
assert.equal(gitBlob(indexBuf),'2a7dae75115d83b4edc368c42453a7cb58d0bd73',
