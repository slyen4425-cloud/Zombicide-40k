...
assert.equal(bytes.length,8172610,'module-launch preaudit guard must track the current S1 runtime');
assert.equal(gitBlob,'eddba424d3ebb086a1bdd0bcc1b1822d16a83771','preaudit runtime blob must match the user-supplied checkpoint file');
