...
const blob=crypto.createHash('sha1')
  ...
  .digest('hex');
assert.equal(bytes.length,8174315,'preaudit must execute the exact verified index');
assert.equal(blob,'0aaafb2eaf42b7bce6520efa633b6b6a6ffbe92a','preaudit index blob drifted');
