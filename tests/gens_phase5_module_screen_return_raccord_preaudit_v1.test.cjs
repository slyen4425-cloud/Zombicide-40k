...
assert.equal(indexBuf.length,8170726,'raccord guard must target current Dungeon S2 runtime size');
assert.equal(gitBlob(indexBuf),'d9ee34d47fa888795db68cdc244d0c73d30ee523',
