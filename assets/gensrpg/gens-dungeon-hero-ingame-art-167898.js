/* GenSrpG V16.78.114.12 — hard guarantee for built-in hero art inside Dungeon boards.
   Repairs the data sources AND the actual hero token DOM while keeping decorative images transparent to touch/click. */
(function(){
"use strict";
const R=typeof window!=="undefined"?window:globalThis,D=typeof document!=="undefined"?document:null;
const VERSION="1.1.0",APP_VERSION="16.78.114.12";
...
function forceImg(img,src,name){if(!img||!src)return 0;let n=0;try{if(img.getAttribute("src")!==src){img.setAttribute("src",src);img.src=src;n++}img.alt=name||img.alt||"";img.style.display="";img.hidden=false;img.draggable=false;img.setAttribute?.("draggable","false");img.style.pointerEvents="none";img.style.userSelect="none";img.style.webkitUserDrag="none"}catch(e){}return n}
