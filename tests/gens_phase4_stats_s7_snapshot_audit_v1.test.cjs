...
assert.equal(bytes.length,8171854,'S7 must audit the exact verified index');
assert.equal(blob,'97f0e060d8bffcde2baaf5aa42c1e16b8544263f','S7 index blob must remain the Rule 26 verified source');
