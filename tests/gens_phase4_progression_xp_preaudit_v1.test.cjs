...
assert.equal(bytes.length,8174649,'Progression preaudit must run on the exact first-raccord index');
assert.equal(blob,'ef8a0ac77019ed08f166a97389dd5bdf4a692841','Progression preaudit index blob drifted');
