...
assert.equal(bytes.length,8174315,'audit 6 must target the current Phase 5 Shell index size');
assert.equal(blob,'0aaafb2eaf42b7bce6520efa633b6b6a6ffbe92a','audit 6 must target the exact post-Economy-Rules index blob');
