...
const blob=crypto.createHash('sha1')
  ...
  .digest('hex');
assert.equal(bytes.length,8173578,'preaudit must execute the exact verified index');
assert.equal(blob,'9313afd3437fe827b9c17245a675f75645570878','preaudit index blob drifted');
