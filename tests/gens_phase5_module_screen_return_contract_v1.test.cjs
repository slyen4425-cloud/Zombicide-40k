...
assert.equal(runtime.length,8170726,'contract-only lot must keep the manually validated runtime size');
assert.equal(gitBlob(runtime),'d9ee34d47fa888795db68cdc244d0c73d30ee523',
