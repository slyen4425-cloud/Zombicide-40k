...
assert.equal(bytes.length,8170472,'Phase 5 exit audit must target the validated captureFix135 GREEN runtime');
assert.equal(gitBlob,'2232d8c1d65121758646915080bd3c17be4d4cd6',
