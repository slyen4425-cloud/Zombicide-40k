...
const blob=crypto.createHash('sha1')
  ...
  .digest('hex');
assert.equal(bytes.length,8172687,'preaudit must execute the exact verified index');
assert.equal(blob,'e56f7b63963d991717e1738c3e5188011276a2b7','preaudit index blob drifted');
