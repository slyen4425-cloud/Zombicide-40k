...
assert.match(dice,/APP_VERSION="16\.78\.111"/);
assert.match(dice,/WATCHDOG_MS=980/);
assert.match(dice,/TICK_COUNT=6/);
...
console.log('V16.78.111 combat runtime performance guard: V110 stat cache + V111 visible dice OK');
