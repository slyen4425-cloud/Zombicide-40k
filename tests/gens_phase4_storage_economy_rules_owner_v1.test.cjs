...
assert.equal(bytes.length,8172505,'post-raccord index size must match the exact Economy rules micro-diff');
assert.equal(blob,'c17460335b2deb5e5916dbf91448b0706c38d0df','post-raccord index blob must match the exact Economy rules micro-diff');
