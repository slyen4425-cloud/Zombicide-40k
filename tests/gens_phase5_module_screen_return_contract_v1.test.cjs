...
assert.equal(runtime.length,8170961,'contract-only lot must keep the manually validated runtime size');
assert.equal(gitBlob(runtime),'0c15b1dba66ce83f2b27ed99e371885fb1d0ed75',
