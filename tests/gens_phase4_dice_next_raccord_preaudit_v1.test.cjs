...
assert.equal(indexBuf.length,8171079,'preaudit must stay aligned to the exact d10048 raccord index');
assert.equal(gitBlob,'6a9392e667881f2087e4df931645cada4201cb3c','preaudit index blob drifted');
