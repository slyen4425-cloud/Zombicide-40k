...
assert.equal(bytes.length,8172610,'S7 must audit the exact verified index');
assert.equal(blob,'eddba424d3ebb086a1bdd0bcc1b1822d16a83771','S7 index blob must remain the Rule 26 verified source');
