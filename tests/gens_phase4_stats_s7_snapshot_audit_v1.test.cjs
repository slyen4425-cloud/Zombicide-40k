...
assert.equal(bytes.length,8170402,'S7 must audit the exact verified index');
assert.equal(blob,'2a7dae75115d83b4edc368c42453a7cb58d0bd73','S7 index blob must remain the Rule 26 verified source');
