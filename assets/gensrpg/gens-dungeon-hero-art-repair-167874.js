/* GenSrpG V16.78.85 — visual repair for built-in Dungeon hero art + stable late runtime bridges.
   Built-in Dungeon heroes always use their official PNG assets. The same always-loaded bridge also
   loads authored final-exit/event modules, shared event placement, and the unified stat extension. */
(function(){
"use strict";
...
R.GensDungeonHeroArtRepair167874={HERO_ART,FINAL_EXIT_SRC,EVENT_CELL_SRC,EVENT_FIX_SRC,UNIFIED_STATS_SRC,forceImg,repairDefs,repairParticipants,repairPicks,repairSheet,repair,loadFinalExit,loadRuntimeBridges,install};
