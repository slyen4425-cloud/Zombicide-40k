...
assert.equal(bytes.length,8170726,'Progression preaudit must run on the exact first-raccord index');
assert.equal(blob,'d9ee34d47fa888795db68cdc244d0c73d30ee523','Progression preaudit index blob drifted');
