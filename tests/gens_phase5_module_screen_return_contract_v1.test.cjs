...
assert.equal(runtime.length,8171854,'contract-only lot must keep the manually validated runtime size');
assert.equal(gitBlob(runtime),'97f0e060d8bffcde2baaf5aa42c1e16b8544263f',
