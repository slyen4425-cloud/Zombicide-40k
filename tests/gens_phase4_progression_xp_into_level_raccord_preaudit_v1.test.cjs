...
assert.equal(indexBuf.length,8170961,'raccord preaudit must use exact contract GREEN index');
assert.equal(gitBlob(indexBuf),'0c15b1dba66ce83f2b27ed99e371885fb1d0ed75','runtime index drifted');
