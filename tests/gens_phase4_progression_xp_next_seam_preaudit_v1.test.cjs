...
assert.equal(indexBuf.length,8169503,'next-seam preaudit must run on exact current index after Survival reserve extraction');
assert.equal(gitBlob(indexBuf),'fb8c77504ed067fb094374260b459f8d1fb7e824','next-seam preaudit index blob drifted');
