...
assert.equal(bytes.length,8171186,'audit 6 must target the current Phase 5 Shell index size');
assert.equal(blob,'c2424bada56517e579ffe65fa147facbb6bf2caf','audit 6 must target the exact post-Economy-Rules index blob');
