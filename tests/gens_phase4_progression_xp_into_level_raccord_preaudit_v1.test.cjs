...
assert.equal(indexBuf.length,8172505,'raccord preaudit must use exact contract GREEN index');
assert.equal(gitBlob(indexBuf),'c17460335b2deb5e5916dbf91448b0706c38d0df','runtime index drifted');
