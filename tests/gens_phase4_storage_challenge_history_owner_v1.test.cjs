...
assert.equal(bytes.length,8169503,'current Phase 5 grid-repair index size must remain deterministic');
assert.equal(blob,'fb8c77504ed067fb094374260b459f8d1fb7e824','current Phase 5 grid-repair index blob must remain deterministic');
