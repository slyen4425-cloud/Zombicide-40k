...
assert.equal(indexBuf.length,8172500,'earned-points preaudit must run on exact xpIntoLevel GREEN index');
assert.equal(gitBlob(indexBuf),'7b586e9fb14b7a93a0edb069e115fd6d48cbda97','earned-points preaudit index blob drifted');
