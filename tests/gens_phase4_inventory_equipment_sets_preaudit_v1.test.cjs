...
const blob=crypto.createHash('sha1')
  ...
  .digest('hex');
assert.equal(bytes.length,8170961,'preaudit must execute the exact verified index');
assert.equal(blob,'0c15b1dba66ce83f2b27ed99e371885fb1d0ed75','preaudit index blob drifted');
