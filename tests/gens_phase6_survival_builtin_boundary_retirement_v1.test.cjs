...
assert.equal(bytes.length,8170150,
  'builtin boundary lot must start from the exact Dungeon-ensure GREEN runtime size');
assert.equal(blob,'ca5cb0b92f4e6ff8779ebe2339bb2be32a89f8f9',
  'builtin boundary lot must target the exact Dungeon-ensure GREEN runtime');
