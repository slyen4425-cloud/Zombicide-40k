...
assert.equal(indexBuf.length,8173578,'preaudit must stay aligned to the exact d10048 raccord index');
assert.equal(gitBlob,'9313afd3437fe827b9c17245a675f75645570878','preaudit index blob drifted');
