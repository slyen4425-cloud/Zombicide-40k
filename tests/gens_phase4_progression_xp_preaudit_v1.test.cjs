...
assert.equal(bytes.length,8172505,'Progression preaudit must run on the exact first-raccord index');
assert.equal(blob,'c17460335b2deb5e5916dbf91448b0706c38d0df','Progression preaudit index blob drifted');
