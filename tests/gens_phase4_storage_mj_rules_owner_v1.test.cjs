...
assert.equal(bytes.length,8170350,'current Phase 7 Dungeon generated-advance index size must remain deterministic');
assert.equal(gitBlob(bytes),'e513d23c7a8c7aef9a187202bbcc34ab540e856f','MJ Rules raccord must target the current Phase 7 Dungeon generated-advance baseline');
