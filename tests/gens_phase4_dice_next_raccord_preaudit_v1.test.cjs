...
assert.equal(indexBuf.length,8170726,'preaudit must stay aligned to the exact d10048 raccord index');
assert.equal(gitBlob,'d9ee34d47fa888795db68cdc244d0c73d30ee523','preaudit index blob drifted');
