...
assert.equal(bytes.length,8170150,'base-reserve lot must start from the exact GREEN Survival skill-library runtime size');
assert.equal(blob,'ca5cb0b92f4e6ff8779ebe2339bb2be32a89f8f9','base-reserve lot must target the exact GREEN Survival skill-library runtime');
