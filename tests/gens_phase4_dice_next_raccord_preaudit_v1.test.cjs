...
assert.equal(indexBuf.length,8171186,'preaudit must stay aligned to the exact d10048 raccord index');
assert.equal(gitBlob,'c2424bada56517e579ffe65fa147facbb6bf2caf','preaudit index blob drifted');
