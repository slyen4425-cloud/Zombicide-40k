...
assert.equal(indexBuf.length,8170881,'next-seam preaudit must run on exact current index after Survival reserve extraction');
assert.equal(gitBlob(indexBuf),'f6a11fa5c0807debc0c9950cc2caf5356c97cfc8','next-seam preaudit index blob drifted');
