...
assert.equal(bytes.length,8174637);
assert.equal(blob,'5b8e790fefe7970a250fd9485ee80549511737e6','Dungeon Scene final index blob must match deterministic micro-diff');
