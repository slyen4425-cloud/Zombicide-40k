...
assert.equal(bytes.length,8171186);
assert.equal(blob,'c2424bada56517e579ffe65fa147facbb6bf2caf','Dungeon Scene final index blob must match deterministic micro-diff');
