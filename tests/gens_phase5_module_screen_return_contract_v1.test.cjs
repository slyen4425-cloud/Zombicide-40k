...
assert.equal(runtime.length,8172118,'contract-only lot must keep the manually validated runtime size');
assert.equal(gitBlob(runtime),'198207e3f52730498831f196caa35c4a0283e934',
