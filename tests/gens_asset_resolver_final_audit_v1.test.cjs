...
assert.equal(blob,'ee7b474802d8bb3b1d20e3aaf2507c4666fbd054','asset resolver final audit must target the current post-Challenge-Library runtime index blob');
