...
assert.match(src,/APP_VERSION="16\.78\.65"/);
...
assert.match(src,/\.drc100Cell\.wall\{background-image:none!important\}/);
...
console.log('Dungeon room visual theme V16.78.65 regression: OK');
