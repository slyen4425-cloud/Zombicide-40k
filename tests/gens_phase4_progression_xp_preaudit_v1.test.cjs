...
assert.equal(bytes.length,8173578,'Progression preaudit must run on the exact first-raccord index');
assert.equal(blob,'9313afd3437fe827b9c17245a675f75645570878','Progression preaudit index blob drifted');
