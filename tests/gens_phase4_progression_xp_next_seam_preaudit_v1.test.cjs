...
assert.equal(indexBuf.length,8171576,'next-seam preaudit must run on exact first-raccord GREEN index');
assert.equal(gitBlob(indexBuf),'12be0fdbaa5c05f7852933b48a3dd5df09da6145','next-seam preaudit index blob drifted');
