...
assert.equal(indexBuf.length,8171079,'raccord RED must start from exact preaudit GREEN index');
assert.equal(gitBlob(indexBuf),'6a9392e667881f2087e4df931645cada4201cb3c','raccord RED index drifted');
