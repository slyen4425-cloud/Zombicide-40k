...
assert.equal(bytes.length,8170961,'Progression preaudit must run on the exact first-raccord index');
assert.equal(blob,'0c15b1dba66ce83f2b27ed99e371885fb1d0ed75','Progression preaudit index blob drifted');
