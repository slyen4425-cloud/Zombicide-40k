...
assert.equal(indexBuf.length,8172529,'raccord preaudit must use exact contract GREEN index');
assert.equal(gitBlob(indexBuf),'696014056409dda9b6ef25ace58dfd9d5f9e2718','runtime index drifted');
