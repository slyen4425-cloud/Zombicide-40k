...
assert.equal(indexBuf.length,8170815,'raccord preaudit must use exact contract GREEN index');
assert.equal(gitBlob(indexBuf),'9c762dcb8ad3549cf7175ba9413f925b11f5396c','runtime index drifted');
