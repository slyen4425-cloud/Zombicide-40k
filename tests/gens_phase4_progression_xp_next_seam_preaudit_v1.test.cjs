...
assert.equal(indexBuf.length,8169596,'next-seam preaudit must run on exact first-raccord GREEN index');
assert.equal(gitBlob(indexBuf),'d451372389f29d0145d3f9689ca739128a0650e9','next-seam preaudit index blob drifted');
