...
assert.equal(indexBuf.length,8172204,'raccord guard must target current Dungeon S2 runtime size');
assert.equal(gitBlob(indexBuf),'6c95e3f6ca4bf8e34003776e7e43e44192aafb16',
