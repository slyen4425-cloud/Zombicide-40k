...
assert.equal(bytes.length,8169596,'post-raccord index size must match the exact Economy rules micro-diff');
assert.equal(blob,'d451372389f29d0145d3f9689ca739128a0650e9','post-raccord index blob must match the exact Economy rules micro-diff');
