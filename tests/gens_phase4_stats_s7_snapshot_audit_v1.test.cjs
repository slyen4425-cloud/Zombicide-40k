...
assert.equal(bytes.length,8170961,'S7 must audit the exact verified index');
assert.equal(blob,'0c15b1dba66ce83f2b27ed99e371885fb1d0ed75','S7 index blob must remain the Rule 26 verified source');
