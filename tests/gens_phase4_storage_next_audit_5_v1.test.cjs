...
assert.equal(bytes.length,8172610,'current Phase 5 Shell index byte size drifted');
assert.equal(blob,'eddba424d3ebb086a1bdd0bcc1b1822d16a83771','audit 5 must target the exact post-Deck index blob');
