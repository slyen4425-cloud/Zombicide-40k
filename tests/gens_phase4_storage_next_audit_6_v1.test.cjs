...
assert.equal(bytes.length,8169047,'audit 6 must target the current Phase 5 grid-repair index size');
assert.equal(blob,'afc271f9e038f77c5c78caa9f4445d0e49eaea5d','audit 6 must target the exact current Phase 5 grid-repair index blob');
