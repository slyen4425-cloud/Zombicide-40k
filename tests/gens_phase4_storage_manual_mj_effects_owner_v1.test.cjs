...
assert.equal(bytes.length,8174580,'post-raccord index size must match the exact micro-diff');
assert.equal(blob,'a070af09f9cb1fcda78987e83bc117d7544d1b6c','post-raccord index blob must match the exact micro-diff');
