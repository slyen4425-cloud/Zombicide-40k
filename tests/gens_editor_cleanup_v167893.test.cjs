...
assert.match(src,/GenSrpG V16\.78\.111/,'cleanup/stability bridge must carry current V16.78.111 layer');
...
assert.match(src,/gens-dice-performance-1678108\.js\?v=1678111/,'mobile dice V111 layer must be loaded from the stable runtime bridge');
...
assert.match(src,/gens-combat-flow-1678111\.js\?v=1678111/,'combat flow layer must be loaded from the stable runtime bridge');
...
console.log('GenSrpG V16.78.111 scoped editor cleanup/stability bridge + V16.78.95 stats engine: OK');
