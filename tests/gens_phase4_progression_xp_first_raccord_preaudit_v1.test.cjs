...
assert.equal(indexBuf.length,8170726,'first-raccord preaudit must track the exact connected index after its dedicated raccord');
assert.equal(indexBlob,'d9ee34d47fa888795db68cdc244d0c73d30ee523','index blob drifted after the dedicated Progression raccord');
