...
assert.equal(indexBuf.length,8172505,'earned-points raccord RED must start from exact preaudit GREEN index');
assert.equal(gitBlob(indexBuf),'c17460335b2deb5e5916dbf91448b0706c38d0df','earned-points raccord RED index drifted');
