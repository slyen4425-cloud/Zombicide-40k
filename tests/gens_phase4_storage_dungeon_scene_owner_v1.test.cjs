...
assert.equal(bytes.length,8171576);
assert.equal(blob,'12be0fdbaa5c05f7852933b48a3dd5df09da6145','Dungeon Scene final index blob must match deterministic micro-diff');
