...
assert.equal(bytes.length,8170726,'current Phase 5 Shell index byte size drifted');
assert.equal(blob,'d9ee34d47fa888795db68cdc244d0c73d30ee523','audit 5 must target the exact post-Deck index blob');
