/* GenSrpG V16.78.108 — visual repair + scoped stability bridge. */
(function(){
"use strict";
...
const DICE_PERF_SRC="assets/gensrpg/gens-dice-performance-1678108.js?v=1678108";
...
function hookAll(){for(const n of ["ensureDungeonHeroes","applyCustomHeroesMulti","loadGame","loadDungeonGame","resumeDungeonGame","renderParticipantSelector","renderMenu","renderHeroes","openChar","openCharacter","openHeroSheet","showHeroSheet","renderCharacterSheet","renderDungeonHeroSheet","renderDungeonHeroStats","renderDungeonAttributes","renderRpgUniverseEditor","saveRpgUniverseStats","openHeroCreator","hcRenderRpgStatsUsage","openEquipmentEditor"])hook(n);return true}
function install(){repairDefs();hookAll();schedule();loadRuntimeBridges();let tries=0;const retry=()=>{hookAll();schedule();loadRuntimeBridges();if(tries++<30)setTimeout(retry,100)};setTimeout(retry,50);return true}
R.GensDungeonHeroArtRepair167874={HERO_ART,FINAL_EXIT_SRC,EVENT_CELL_SRC,EVENT_FIX_SRC,GRID_RECOVERY_SRC,HERO_EDITOR_SRC,HERO_INGAME_SRC,SHEET_ART_SRC,STAT_POLICY_SRC,UI_CLEANUP_SRC,EQUIPMENT_CLEANUP_SRC,BONUS_PERSIST_SRC,ENEMY_STATS_SRC,DETECTION_SRC,DICE_PERF_SRC,LEGACY_EDITOR_CONTROL_IDS,forceImg,repairDefs,repairParticipants,repairPicks,repairSheet,repair,cleanupLegacyRpgEditor,loadFinalExit,loadRuntimeBridges,hookAll,install};
