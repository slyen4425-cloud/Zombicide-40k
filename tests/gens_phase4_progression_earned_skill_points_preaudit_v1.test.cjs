...
assert.equal(indexBuf.length,8170150,'earned-points preaudit must run on exact xpIntoLevel GREEN index');
assert.equal(gitBlob(indexBuf),'ca5cb0b92f4e6ff8779ebe2339bb2be32a89f8f9','earned-points preaudit index blob drifted');
