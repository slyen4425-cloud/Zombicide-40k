...
assert.equal(bytes.length,8172118,'current Phase 5 grid-repair index size must remain deterministic');
assert.equal(blob,'198207e3f52730498831f196caa35c4a0283e934','current Phase 5 grid-repair index blob must remain deterministic');
