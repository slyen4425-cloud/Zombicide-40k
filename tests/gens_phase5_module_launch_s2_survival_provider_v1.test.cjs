...
assert.equal(bytes.length,8170815,'S2 runtime must match the exact Survival-provider candidate');
assert.equal(gitBlob,'9c762dcb8ad3549cf7175ba9413f925b11f5396c','S2 runtime blob must match the exact Survival-provider candidate');
