...
assert.equal(bytes.length,8169503,'S4 preaudit/postaudit must track the current validated runtime');
assert.equal(gitBlob,'fb8c77504ed067fb094374260b459f8d1fb7e824','S4 preaudit/postaudit blob must track the current validated runtime');
