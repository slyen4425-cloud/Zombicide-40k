...
assert.equal(bytes.length,8169596,'openChar guard must target the current Core 0.28-retired runtime');
assert.equal(gitBlob(bytes),'d451372389f29d0145d3f9689ca739128a0650e9',
