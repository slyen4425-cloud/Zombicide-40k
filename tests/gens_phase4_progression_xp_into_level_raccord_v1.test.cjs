...
assert.equal(indexBuf.length,8171571,'raccord RED must start from exact preaudit GREEN index');
assert.equal(gitBlob(indexBuf),'6e76a99af5fb839db5ffb20a2e67fd1572bf13ea','raccord RED index drifted');
