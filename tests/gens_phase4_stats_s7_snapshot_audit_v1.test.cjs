...
assert.equal(bytes.length,8171879,'S7 must audit the exact verified index');
assert.equal(blob,'7601760f7a635094d4f687b725a639b5728e93b4','S7 index blob must remain the Rule 26 verified source');
