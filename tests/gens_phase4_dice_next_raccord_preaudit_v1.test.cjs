...
assert.equal(indexBuf.length,8172204,'preaudit must stay aligned to the exact d10048 raccord index');
assert.equal(gitBlob,'6c95e3f6ca4bf8e34003776e7e43e44192aafb16','preaudit index blob drifted');
