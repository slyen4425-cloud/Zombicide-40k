...
assert.equal(indexBuf.length,8171571,'next-seam preaudit must run on exact first-raccord GREEN index');
assert.equal(gitBlob(indexBuf),'6e76a99af5fb839db5ffb20a2e67fd1572bf13ea','next-seam preaudit index blob drifted');
