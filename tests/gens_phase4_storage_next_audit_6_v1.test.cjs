...
assert.equal(bytes.length,8173578,'audit 6 must target the current Phase 5 Shell index size');
assert.equal(blob,'9313afd3437fe827b9c17245a675f75645570878','audit 6 must target the exact post-Economy-Rules index blob');
