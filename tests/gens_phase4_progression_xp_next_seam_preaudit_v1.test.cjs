...
assert.equal(indexBuf.length,8174649,'next-seam preaudit must run on exact first-raccord GREEN index');
assert.equal(gitBlob(indexBuf),'ef8a0ac77019ed08f166a97389dd5bdf4a692841','next-seam preaudit index blob drifted');
