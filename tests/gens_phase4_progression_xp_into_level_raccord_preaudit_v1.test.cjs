...
assert.equal(indexBuf.length,8172610,'raccord preaudit must use exact contract GREEN index');
assert.equal(gitBlob(indexBuf),'eddba424d3ebb086a1bdd0bcc1b1822d16a83771','runtime index drifted');
