...
assert.equal(indexBuf.length,8171854,'raccord RED must start from exact preaudit GREEN index');
assert.equal(gitBlob(indexBuf),'97f0e060d8bffcde2baaf5aa42c1e16b8544263f','raccord RED index drifted');
