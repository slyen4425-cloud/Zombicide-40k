...
function install(){repairDefs();for(const n of ["ensureDungeonHeroes","renderParticipantSelector","renderMenu","openChar"])hook(n);observe();schedule();return true}
R.GensDungeonHeroArtRepair167874={HERO_ART,forceImg,repairDefs,repairParticipants,repairPicks,repairSheet,repair,install};
