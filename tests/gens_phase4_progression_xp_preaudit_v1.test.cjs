...
assert.equal(bytes.length,8170730,'Progression preaudit must run on the exact first-raccord index');
assert.equal(blob,'7663392f163aac32c4c3b918cbce67472856b3b6','Progression preaudit index blob drifted');
