...
assert.equal(reachable.size,66,'production graph size drifted before owner validation');
assert.equal(mapped.size,66,'owner manifest must currently map all 66 production-reachable files');
