...
const blob=crypto.createHash('sha1')
  ...
  .digest('hex');
assert.equal(bytes.length,8171795,'preaudit must execute the exact verified index');
assert.equal(blob,'4f8c3b9be4189a9ac163fcb17531c95cbd783b05','preaudit index blob drifted');
