...
assert.equal(bytes.length,8171571,'current Phase 5 Shell index byte size drifted');
assert.equal(blob,'6e76a99af5fb839db5ffb20a2e67fd1572bf13ea','audit 5 must target the exact post-Deck index blob');
