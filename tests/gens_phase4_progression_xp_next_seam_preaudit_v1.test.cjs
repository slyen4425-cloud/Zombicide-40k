...
assert.equal(indexBuf.length,8170150,'next-seam preaudit must run on exact current index after Survival reserve extraction');
assert.equal(gitBlob(indexBuf),'ca5cb0b92f4e6ff8779ebe2339bb2be32a89f8f9','next-seam preaudit index blob drifted');
