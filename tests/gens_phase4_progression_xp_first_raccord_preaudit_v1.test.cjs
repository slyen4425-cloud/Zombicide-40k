...
assert.equal(indexBuf.length,8171186,'first-raccord preaudit must track the exact connected index after its dedicated raccord');
assert.equal(indexBlob,'c2424bada56517e579ffe65fa147facbb6bf2caf','index blob drifted after the dedicated Progression raccord');
