...
assert.match(src,/GenSrpG V16\.78\.99/,'cleanup/stability bridge must carry V16.78.99');
...
console.log('GenSrpG V16.78.99 scoped editor cleanup/stability bridge + V16.78.95 stats engine: OK');
