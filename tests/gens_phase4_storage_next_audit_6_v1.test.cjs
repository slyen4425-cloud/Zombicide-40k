...
assert.equal(bytes.length,8172118,'audit 6 must target the current Phase 5 grid-repair index size');
assert.equal(blob,'198207e3f52730498831f196caa35c4a0283e934','audit 6 must target the exact current Phase 5 grid-repair index blob');
