...
const blob=crypto.createHash('sha1')
  ...
  .digest('hex');
assert.equal(bytes.length,8174416,'preaudit must execute the exact verified index');
assert.equal(blob,'a68bcbaf5d16bdbe2e70cbe0959a421371554fcc','preaudit index blob drifted');
