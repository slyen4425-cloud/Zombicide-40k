...
assert.equal(indexBuf.length,8172204,'earned-points preaudit must run on exact xpIntoLevel GREEN index');
assert.equal(gitBlob(indexBuf),'6c95e3f6ca4bf8e34003776e7e43e44192aafb16','earned-points preaudit index blob drifted');
