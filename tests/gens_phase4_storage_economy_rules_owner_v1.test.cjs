...
assert.equal(bytes.length,8171795,'post-raccord index size must match the exact Economy rules micro-diff');
assert.equal(blob,'4f8c3b9be4189a9ac163fcb17531c95cbd783b05','post-raccord index blob must match the exact Economy rules micro-diff');
