...
assert.equal(indexBuf.length,8174416,'raccord RED must start from exact preaudit GREEN index');
assert.equal(gitBlob(indexBuf),'a68bcbaf5d16bdbe2e70cbe0959a421371554fcc','raccord RED index drifted');
