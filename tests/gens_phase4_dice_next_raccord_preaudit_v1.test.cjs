...
assert.equal(indexBuf.length,8174148,'preaudit must stay aligned to the exact d10048 raccord index');
assert.equal(gitBlob,'f13835a2827dbfa9e2698cb026d3e732ad62aba4','preaudit index blob drifted');
