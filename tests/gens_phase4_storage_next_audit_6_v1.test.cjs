...
assert.equal(bytes.length,8174649,'audit 6 must target the current Phase 5 Shell index size');
assert.equal(blob,'ef8a0ac77019ed08f166a97389dd5bdf4a692841','audit 6 must target the exact post-Economy-Rules index blob');
