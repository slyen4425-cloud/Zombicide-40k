...
const expected={dc200StartCombat:1,openDungeonCombatSetup:1,launchCombat200:2,startCombat:5};
...
// Lot 4I: Runtime 2.00 stealth failure now enters through the canonical Bridge while
