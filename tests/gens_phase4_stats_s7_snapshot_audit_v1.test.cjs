...
assert.equal(bytes.length,8174649,'S7 must audit the exact verified index');
assert.equal(blob,'ef8a0ac77019ed08f166a97389dd5bdf4a692841','S7 index blob must remain the Rule 26 verified source');
