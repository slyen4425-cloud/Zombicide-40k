...
assert.equal(indexBuf.length,8173578,'earned-points raccord RED must start from exact preaudit GREEN index');
assert.equal(gitBlob(indexBuf),'9313afd3437fe827b9c17245a675f75645570878','earned-points raccord RED index drifted');
