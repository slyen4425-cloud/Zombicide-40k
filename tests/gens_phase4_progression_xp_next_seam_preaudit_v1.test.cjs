...
assert.equal(indexBuf.length,8171879,'next-seam preaudit must run on exact first-raccord GREEN index');
assert.equal(gitBlob(indexBuf),'cacee0bb95d8c046264668c1ccc721fc88bbed2d','next-seam preaudit index blob drifted');
