...
assert.equal(bytes.length,8172118,'S4 provider contract must run on the exact Core200-global-retired runtime');
assert.equal(gitBlob,'198207e3f52730498831f196caa35c4a0283e934','S4 provider contract must keep the exact reviewed Core200 retirement blob');
