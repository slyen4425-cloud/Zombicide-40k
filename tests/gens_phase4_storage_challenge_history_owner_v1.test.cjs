...
assert.equal(bytes.length,8169596,'current Phase 5 grid-repair index size must remain deterministic');
assert.equal(blob,'d451372389f29d0145d3f9689ca739128a0650e9','current Phase 5 grid-repair index blob must remain deterministic');
