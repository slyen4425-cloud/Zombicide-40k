...
assert.equal(bytes.length,8170150,'S7 must audit the exact verified index');
assert.equal(blob,'ca5cb0b92f4e6ff8779ebe2339bb2be32a89f8f9','S7 index blob must remain the Rule 26 verified source');
