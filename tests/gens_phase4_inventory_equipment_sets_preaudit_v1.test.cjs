...
const blob=crypto.createHash('sha1')
  ...
  .digest('hex');
assert.equal(bytes.length,8174649,'preaudit must execute the exact verified index');
assert.equal(blob,'ef8a0ac77019ed08f166a97389dd5bdf4a692841','preaudit index blob drifted');
