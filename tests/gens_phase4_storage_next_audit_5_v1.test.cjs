...
assert.equal(bytes.length,8172204,'current Phase 5 Shell index byte size drifted');
assert.equal(blob,'6c95e3f6ca4bf8e34003776e7e43e44192aafb16','audit 5 must target the exact post-Deck index blob');
