...
assert.equal(runtime.length,8172610,'contract-only lot must keep the manually validated runtime size');
assert.equal(gitBlob(runtime),'eddba424d3ebb086a1bdd0bcc1b1822d16a83771',
