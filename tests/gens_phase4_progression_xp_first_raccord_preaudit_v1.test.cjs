...
assert.equal(indexBuf.length,8169596,'first-raccord preaudit must track the exact connected index after its dedicated raccord');
assert.equal(indexBlob,'d451372389f29d0145d3f9689ca739128a0650e9','index blob drifted after the dedicated Progression raccord');
