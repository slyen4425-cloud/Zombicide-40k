...
assert.equal(bytes.length,8172610,'Progression preaudit must run on the exact first-raccord index');
assert.equal(blob,'eddba424d3ebb086a1bdd0bcc1b1822d16a83771','Progression preaudit index blob drifted');
