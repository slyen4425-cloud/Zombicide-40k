...
assert.equal(bytes.length,8171576,'current index size must include the later Challenge Library micro-diff');
assert.equal(blob,'12be0fdbaa5c05f7852933b48a3dd5df09da6145','current index blob must include the later Challenge Library micro-diff');
