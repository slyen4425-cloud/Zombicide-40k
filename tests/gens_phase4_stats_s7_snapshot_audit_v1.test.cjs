...
assert.equal(bytes.length,8174315,'S7 must audit the exact verified index');
assert.equal(blob,'0aaafb2eaf42b7bce6520efa633b6b6a6ffbe92a','S7 index blob must remain the Rule 26 verified source');
