...
assert.equal(indexBuf.length,8171576,'first-raccord preaudit must track the exact connected index after its dedicated raccord');
assert.equal(indexBlob,'12be0fdbaa5c05f7852933b48a3dd5df09da6145','index blob drifted after the dedicated Progression raccord');
