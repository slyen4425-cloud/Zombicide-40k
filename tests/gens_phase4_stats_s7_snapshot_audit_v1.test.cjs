...
assert.equal(bytes.length,8171186,'S7 must audit the exact verified index');
assert.equal(blob,'c2424bada56517e579ffe65fa147facbb6bf2caf','S7 index blob must remain the Rule 26 verified source');
