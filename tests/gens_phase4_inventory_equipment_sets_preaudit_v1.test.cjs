...
const blob=crypto.createHash('sha1')
  ...
  .digest('hex');
assert.equal(bytes.length,8170402,'preaudit must execute the exact verified index');
assert.equal(blob,'2a7dae75115d83b4edc368c42453a7cb58d0bd73','preaudit index blob drifted');
