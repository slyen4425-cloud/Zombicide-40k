...
assert.equal(indexBuf.length,8170350,'raccord must start from the exact Phase 7 preaudit GREEN index');
assert.equal(gitBlob(indexBuf),'e513d23c7a8c7aef9a187202bbcc34ab540e856f','raccord Phase 7 index drifted');
