...
assert.equal(bytes.length,8170730,'openChar guard must target the current Core 0.28-retired runtime');
assert.equal(gitBlob(bytes),'7663392f163aac32c4c3b918cbce67472856b3b6',
