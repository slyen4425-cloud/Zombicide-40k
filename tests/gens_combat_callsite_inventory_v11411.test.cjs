...
const expected={dc200StartCombat:1,openDungeonCombatSetup:1,launchCombat200:2,startCombat:2};
...
// migrates manual, lot 4L ambush and lot 4M cell, leaving only definition/alias.
...
// original guards, live-enemy source, enemyIds and reason.
...
// Lot 4M: Dungeon keeps the exact cell target plus its probabilistic nearby
// reinforcements and popup; Bridge/V113 keeps canonical participant/scope authority
// while limitEnemyIdsToRequest prevents unrelated visible enemies from being added.
require('./gens_core200_cell_entry_characterization_lot4m.test.cjs');
require('./gens_core200_cell_bridge_contract_lot4m.test.cjs');
