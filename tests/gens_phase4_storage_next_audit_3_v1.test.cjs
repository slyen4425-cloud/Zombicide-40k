...
assert.equal(index.length,8169503,'index.html byte size drifted from Phase 6 Survival wave-rules extraction baseline');
assert.equal(blobSha,'fb8c77504ed067fb094374260b459f8d1fb7e824','index.html blob must remain the Phase 6 Survival wave-rules extraction source');
