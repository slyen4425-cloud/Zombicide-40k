...
assert.equal(bytes.length,8174580,'MJ Rules micro-diff must keep exact index size');
assert.equal(gitBlob(bytes),'5b9b9ae780f735eadef049afeb10acf0b57441fe','MJ Rules raccord must match deterministic target blob');
