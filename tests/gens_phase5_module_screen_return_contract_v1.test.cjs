...
assert.equal(runtime.length,8171576,'contract-only lot must keep the manually validated runtime size');
assert.equal(gitBlob(runtime),'12be0fdbaa5c05f7852933b48a3dd5df09da6145',
