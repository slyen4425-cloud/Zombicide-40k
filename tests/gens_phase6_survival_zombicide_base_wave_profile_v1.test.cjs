...
assert.equal(bytes.length,8169047,'micro-lot 3 must start from the final GREEN micro-lot 2 index');
assert.equal(blob,'afc271f9e038f77c5c78caa9f4445d0e49eaea5d','micro-lot 3 must target the exact micro-lot 2 runtime');
