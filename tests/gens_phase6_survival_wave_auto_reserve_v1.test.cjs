...
assert.equal(bytes.length,8170150,'micro-lot 4 must start from the final GREEN micro-lot 3 index');
assert.equal(blob,'ca5cb0b92f4e6ff8779ebe2339bb2be32a89f8f9','micro-lot 4 must target the exact final GREEN micro-lot 3 runtime');
