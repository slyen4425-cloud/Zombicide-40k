...
assert.equal(bytes.length,8170472,'S7 must audit the exact verified index');
assert.equal(blob,'2232d8c1d65121758646915080bd3c17be4d4cd6','S7 index blob must remain the Rule 26 verified source');
