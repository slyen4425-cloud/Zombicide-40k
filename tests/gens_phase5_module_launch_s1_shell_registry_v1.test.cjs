...
assert.equal(bytes.length,8169047,'current runtime must preserve the S1 registry candidate');
assert.equal(gitBlob,'afc271f9e038f77c5c78caa9f4445d0e49eaea5d','current runtime blob must preserve the S1 registry candidate');
