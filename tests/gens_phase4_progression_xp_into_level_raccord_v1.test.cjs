...
assert.equal(indexBuf.length,8170143,'raccord must start from the exact Phase 7 room-kind index');
assert.equal(gitBlob(indexBuf),'23b4f59009c5e51fdb91e9bfe3fd87d2a79bba3d','raccord Phase 7 room-kind index drifted');
