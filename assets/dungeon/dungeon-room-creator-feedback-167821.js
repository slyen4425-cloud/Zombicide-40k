...
function loadTextUtils(){if(!DOC||ROOT.DungeonRoomContentUI167831)return;if(ROOT.GensTextUtilsV1){loadIntuitiveUI();return}const old=DOC.getElementById("gtuV1Script");if(old){old.addEventListener("load",loadIntuitiveUI,{once:true});return}const u=DOC.createElement("script");u.id="gtuV1Script";u.src="assets/gensrpg/core/text-utils-v1.js";u.async=false;u.onload=loadIntuitiveUI;DOC.body.appendChild(u)}
function loadGridCapture(){if(!DOC)return;if(ROOT.DungeonRoomGridCapture167830){loadTextUtils();return}if(DOC.getElementById("drgc167830Script")){setTimeout(loadGridCapture,50);return}const g=DOC.createElement("script");g.id="drgc167830Script";g.src="assets/dungeon/dungeon-room-grid-capture-167830.js?v=167833";g.async=false;g.onload=loadTextUtils;DOC.body.appendChild(g)}
