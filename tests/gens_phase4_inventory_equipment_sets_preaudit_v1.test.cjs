...
const blob=crypto.createHash('sha1')
  ...
  .digest('hex');
assert.equal(bytes.length,8171854,'preaudit must execute the exact verified index');
assert.equal(blob,'97f0e060d8bffcde2baaf5aa42c1e16b8544263f','preaudit index blob drifted');
