...
assert.equal(index.length,8172529,'index.html byte size drifted from current Phase 5 Shell baseline');
assert.equal(blobSha,'696014056409dda9b6ef25ace58dfd9d5f9e2718','index.html blob must remain the current Phase 5 Shell baseline source');
