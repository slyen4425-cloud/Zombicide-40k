...
assert.equal(bytes.length,8170881,'S3 RED must start from the exact S2 GREEN runtime');
assert.equal(gitBlob,'f6a11fa5c0807debc0c9950cc2caf5356c97cfc8','S3 RED must start from the exact S2 GREEN blob');
