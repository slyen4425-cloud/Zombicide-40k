...
assert.equal(runtime.length,8172687,'contract-only lot must keep the manually validated runtime size');
assert.equal(gitBlob(runtime),'e56f7b63963d991717e1738c3e5188011276a2b7',
