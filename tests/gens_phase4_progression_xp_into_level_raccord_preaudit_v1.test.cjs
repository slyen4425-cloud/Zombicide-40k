...
assert.equal(indexBuf.length,8171879,'raccord preaudit must use exact contract GREEN index');
assert.equal(gitBlob(indexBuf),'cacee0bb95d8c046264668c1ccc721fc88bbed2d','runtime index drifted');
