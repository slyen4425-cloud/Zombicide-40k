...
assert.equal(indexBuf.length,8170726,'raccord preaudit must use exact contract GREEN index');
assert.equal(gitBlob(indexBuf),'d9ee34d47fa888795db68cdc244d0c73d30ee523','runtime index drifted');
