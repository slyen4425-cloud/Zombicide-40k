...
assert.equal(indexBuf.length,8172500,'preaudit must stay aligned to the exact d10048 raccord index');
assert.equal(gitBlob,'7b586e9fb14b7a93a0edb069e115fd6d48cbda97','preaudit index blob drifted');
