...
assert.equal(indexBuf.length,8169596,'raccord preaudit must use exact contract GREEN index');
assert.equal(gitBlob(indexBuf),'d451372389f29d0145d3f9689ca739128a0650e9','runtime index drifted');
