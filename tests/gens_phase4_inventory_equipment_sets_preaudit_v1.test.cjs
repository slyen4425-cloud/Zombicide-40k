...
const blob=crypto.createHash('sha1')
  ...
  .digest('hex');
assert.equal(bytes.length,8171879,'preaudit must execute the exact verified index');
assert.equal(blob,'cacee0bb95d8c046264668c1ccc721fc88bbed2d','preaudit index blob drifted');
