...
assert.equal(bytes.length,8172118,'Progression preaudit must run on the exact first-raccord index');
assert.equal(blob,'198207e3f52730498831f196caa35c4a0283e934','Progression preaudit index blob drifted');
