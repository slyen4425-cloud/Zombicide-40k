...
assert.equal(bytes.length,8172529,'S3 RED must start from the exact S2 GREEN runtime');
assert.equal(gitBlob,'696014056409dda9b6ef25ace58dfd9d5f9e2718','S3 RED must start from the exact S2 GREEN blob');
