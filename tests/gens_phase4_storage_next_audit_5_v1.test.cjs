...
assert.equal(bytes.length,8174315,'current Phase 5 Shell index byte size drifted');
assert.equal(blob,'0aaafb2eaf42b7bce6520efa633b6b6a6ffbe92a','audit 5 must target the exact post-Deck index blob');
