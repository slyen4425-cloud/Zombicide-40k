...
assert.equal(bytes.length,8170881,'current Phase 5 grid-repair index size must remain deterministic');
assert.equal(blob,'f6a11fa5c0807debc0c9950cc2caf5356c97cfc8','current Phase 5 grid-repair index blob must remain deterministic');
