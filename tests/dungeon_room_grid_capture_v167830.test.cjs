...
assert.match(loader,/dungeon-room-grid-capture-167830\.js\?v=167832/,'loader must cache-bust the capture guard with V16.78.32');
assert.match(loader,/dungeon-room-content-ui-167831\.js\?v=167832/,'intuitive UI must load after capture guard');
...
console.log('Dungeon Room grid capture V16.78.32 loading regression: OK');
