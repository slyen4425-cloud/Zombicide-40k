...
assert.equal(indexBuf.length,8170726,'next-seam preaudit must run on exact first-raccord GREEN index');
assert.equal(gitBlob(indexBuf),'d9ee34d47fa888795db68cdc244d0c73d30ee523','next-seam preaudit index blob drifted');
