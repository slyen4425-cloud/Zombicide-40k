...
assert.equal(bytes.length,8172687,'S7 must audit the exact verified index');
assert.equal(blob,'e56f7b63963d991717e1738c3e5188011276a2b7','S7 index blob must remain the Rule 26 verified source');
