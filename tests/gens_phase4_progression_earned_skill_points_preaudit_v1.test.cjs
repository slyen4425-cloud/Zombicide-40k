...
assert.equal(indexBuf.length,8171795,'earned-points preaudit must run on exact xpIntoLevel GREEN index');
assert.equal(gitBlob(indexBuf),'4f8c3b9be4189a9ac163fcb17531c95cbd783b05','earned-points preaudit index blob drifted');
