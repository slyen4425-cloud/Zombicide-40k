...
assert.equal(bytes.length,8169047,'micro-lot 5 must target the exact connected runtime size');
assert.equal(blob,'afc271f9e038f77c5c78caa9f4445d0e49eaea5d','micro-lot 5 must target the exact connected runtime');
