...
assert.equal(indexBuf.length,8171186,'raccord RED must start from exact preaudit GREEN index');
assert.equal(gitBlob(indexBuf),'c2424bada56517e579ffe65fa147facbb6bf2caf','raccord RED index drifted');
