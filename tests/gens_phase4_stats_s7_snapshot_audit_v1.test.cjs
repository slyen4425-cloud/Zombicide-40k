...
assert.equal(bytes.length,8170881,'S7 must audit the exact verified index');
assert.equal(blob,'f6a11fa5c0807debc0c9950cc2caf5356c97cfc8','S7 index blob must remain the Rule 26 verified source');
