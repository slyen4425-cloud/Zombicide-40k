...
assert.equal(bytes.length,8170815,'S3 RED must start from the exact S2 GREEN runtime');
assert.equal(gitBlob,'9c762dcb8ad3549cf7175ba9413f925b11f5396c','S3 RED must start from the exact S2 GREEN blob');
