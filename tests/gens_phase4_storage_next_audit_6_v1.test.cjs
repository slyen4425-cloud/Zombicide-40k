...
assert.equal(bytes.length,8169596,'audit 6 must target the current Phase 5 grid-repair index size');
assert.equal(blob,'d451372389f29d0145d3f9689ca739128a0650e9','audit 6 must target the exact current Phase 5 grid-repair index blob');
