...
assert.equal(bytes.length,8169047,'S3 RED must start from the exact S2 GREEN runtime');
assert.equal(gitBlob,'afc271f9e038f77c5c78caa9f4445d0e49eaea5d','S3 RED must start from the exact S2 GREEN blob');
