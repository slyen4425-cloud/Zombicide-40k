...
assert.equal(indexBuf.length,8172500,'contract lot must stay on exact preaudit GREEN index');
assert.equal(gitBlob(indexBuf),'7b586e9fb14b7a93a0edb069e115fd6d48cbda97','index runtime must remain untouched by pure contract lot');
