...
assert.equal(runtime.length,8170730,'contract-only lot must keep the manually validated runtime size');
assert.equal(gitBlob(runtime),'7663392f163aac32c4c3b918cbce67472856b3b6',
