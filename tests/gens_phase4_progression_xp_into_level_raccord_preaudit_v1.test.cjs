...
assert.equal(indexBuf.length,8174314,'raccord preaudit must use exact contract GREEN index');
assert.equal(gitBlob(indexBuf),'8ef7c65fca1f72f0393f0f6ccb6fea8426b41f91','runtime index drifted');
