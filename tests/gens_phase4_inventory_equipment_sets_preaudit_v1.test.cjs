...
const blob=crypto.createHash('sha1')
  ...
  .digest('hex');
assert.equal(bytes.length,8170815,'preaudit must execute the exact verified index');
assert.equal(blob,'9c762dcb8ad3549cf7175ba9413f925b11f5396c','preaudit index blob drifted');
