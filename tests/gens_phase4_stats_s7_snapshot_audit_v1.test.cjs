...
assert.equal(bytes.length,8172742,'S7 must audit the exact verified index');
assert.equal(blob,'95f8c96e7e221eb743f7c8013ffa8af499eca1c8','S7 index blob must remain the Rule 26 verified source');
