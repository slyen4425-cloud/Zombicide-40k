...
assert.equal(indexBuf.length,8172118,'preaudit must stay aligned to the exact d10048 raccord index');
assert.equal(gitBlob,'198207e3f52730498831f196caa35c4a0283e934','preaudit index blob drifted');
