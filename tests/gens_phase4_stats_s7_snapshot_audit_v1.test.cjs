...
assert.equal(bytes.length,8172529,'S7 must audit the exact verified index');
assert.equal(blob,'696014056409dda9b6ef25ace58dfd9d5f9e2718','S7 index blob must remain the Rule 26 verified source');
