...
assert.equal(bytes.length,8172118,'S7 must audit the exact verified index');
assert.equal(blob,'198207e3f52730498831f196caa35c4a0283e934','S7 index blob must remain the Rule 26 verified source');
