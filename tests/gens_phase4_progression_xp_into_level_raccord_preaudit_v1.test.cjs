...
assert.equal(indexBuf.length,8174649,'raccord preaudit must use exact contract GREEN index');
assert.equal(gitBlob(indexBuf),'ef8a0ac77019ed08f166a97389dd5bdf4a692841','runtime index drifted');
