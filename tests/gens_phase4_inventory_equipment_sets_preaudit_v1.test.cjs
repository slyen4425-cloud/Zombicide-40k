...
const blob=crypto.createHash('sha1')
  ...
  .digest('hex');
assert.equal(bytes.length,8172118,'preaudit must execute the exact verified index');
assert.equal(blob,'198207e3f52730498831f196caa35c4a0283e934','preaudit index blob drifted');
