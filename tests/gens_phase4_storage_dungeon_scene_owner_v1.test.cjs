...
assert.equal(bytes.length,8170961);
assert.equal(blob,'0c15b1dba66ce83f2b27ed99e371885fb1d0ed75','Dungeon Scene final index blob must match deterministic micro-diff');
