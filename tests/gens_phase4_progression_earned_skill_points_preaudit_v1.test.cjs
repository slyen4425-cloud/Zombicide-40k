...
assert.equal(indexBuf.length,8172529,'earned-points preaudit must run on exact xpIntoLevel GREEN index');
assert.equal(gitBlob(indexBuf),'696014056409dda9b6ef25ace58dfd9d5f9e2718','earned-points preaudit index blob drifted');
