...
assert.equal(indexBuf.length,8171186,'raccord preaudit must use exact contract GREEN index');
assert.equal(gitBlob(indexBuf),'c2424bada56517e579ffe65fa147facbb6bf2caf','runtime index drifted');
