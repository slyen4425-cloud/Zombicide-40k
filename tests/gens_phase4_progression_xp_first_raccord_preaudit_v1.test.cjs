...
assert.equal(indexBuf.length,8172505,'first-raccord preaudit must track the exact connected index after its dedicated raccord');
assert.equal(indexBlob,'c17460335b2deb5e5916dbf91448b0706c38d0df','index blob drifted after the dedicated Progression raccord');
