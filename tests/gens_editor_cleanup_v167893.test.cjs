...
assert.match(src,/GenSrpG V16\.78\.104/,'cleanup/stability bridge must carry current V16.78.104 layer');
...
console.log('GenSrpG V16.78.104 scoped editor cleanup/stability bridge + V16.78.95 stats engine: OK');
