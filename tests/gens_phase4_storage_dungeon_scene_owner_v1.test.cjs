...
assert.equal(bytes.length,8171079);
assert.equal(blob,'6a9392e667881f2087e4df931645cada4201cb3c','Dungeon Scene final index blob must match deterministic micro-diff');
