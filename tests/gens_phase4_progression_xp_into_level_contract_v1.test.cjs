...
assert.equal(indexBuf.length,8170730,'contract lot must stay on exact preaudit GREEN index');
assert.equal(gitBlob(indexBuf),'7663392f163aac32c4c3b918cbce67472856b3b6','index runtime must remain untouched by pure contract lot');
