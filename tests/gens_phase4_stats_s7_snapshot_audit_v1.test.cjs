...
assert.equal(bytes.length,8172204,'S7 must audit the exact verified index');
assert.equal(blob,'6c95e3f6ca4bf8e34003776e7e43e44192aafb16','S7 index blob must remain the Rule 26 verified source');
