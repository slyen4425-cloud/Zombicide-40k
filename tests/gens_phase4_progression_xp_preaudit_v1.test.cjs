...
assert.equal(bytes.length,8172687,'Progression preaudit must run on the exact first-raccord index');
assert.equal(blob,'e56f7b63963d991717e1738c3e5188011276a2b7','Progression preaudit index blob drifted');
