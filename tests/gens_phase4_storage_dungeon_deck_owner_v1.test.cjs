...
assert.equal(bytes.length,8174603,'post-raccord index size must match the exact micro-diff');
assert.equal(blob,'739ca52610308d085ecf2635c5bc748f70c79a11','post-raccord index blob must match the exact micro-diff');
