...
assert.equal(bytes.length,8172610,'S4 preaudit/postaudit must track the current validated runtime');
assert.equal(gitBlob,'eddba424d3ebb086a1bdd0bcc1b1822d16a83771','S4 preaudit/postaudit blob must track the current validated runtime');
