...
assert.equal(bytes.length,8171795,'S7 must audit the exact verified index');
assert.equal(blob,'4f8c3b9be4189a9ac163fcb17531c95cbd783b05','S7 index blob must remain the Rule 26 verified source');
