...
assert.equal(indexBuf.length,8169596,'preaudit must stay aligned to the exact d10048 raccord index');
assert.equal(gitBlob,'d451372389f29d0145d3f9689ca739128a0650e9','preaudit index blob drifted');
