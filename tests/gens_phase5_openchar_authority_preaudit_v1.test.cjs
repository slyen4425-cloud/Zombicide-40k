...
assert.equal(bytes.length,8170472,'openChar guard must target the current Core 0.28-retired runtime');
assert.equal(gitBlob(bytes),'2232d8c1d65121758646915080bd3c17be4d4cd6',
