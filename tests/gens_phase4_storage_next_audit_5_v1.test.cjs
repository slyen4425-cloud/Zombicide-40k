...
assert.equal(bytes.length,8170730,'repaired Phase 5 Dungeon grid index byte size drifted');
assert.equal(blob,'7663392f163aac32c4c3b918cbce67472856b3b6','audit 5 must target the exact repaired Dungeon grid index blob');
