...
assert.equal(indexBuf.length,8174648,'preaudit must stay aligned to the exact d10048 raccord index');
assert.equal(gitBlob,'2d7677950f04e9a3290ff0062e157a126123891d','preaudit index blob drifted');
