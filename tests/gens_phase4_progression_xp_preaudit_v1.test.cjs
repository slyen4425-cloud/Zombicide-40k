...
assert.equal(bytes.length,8172742,'Progression preaudit must run on the exact first-raccord index');
assert.equal(blob,'95f8c96e7e221eb743f7c8013ffa8af499eca1c8','Progression preaudit index blob drifted');
