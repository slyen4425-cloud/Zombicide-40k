...
assert.equal(index.length,8170961,'index.html byte size drifted from current Phase 5 Shell baseline');
assert.equal(blobSha,'0c15b1dba66ce83f2b27ed99e371885fb1d0ed75','index.html blob must remain the current Phase 5 Shell baseline source');
