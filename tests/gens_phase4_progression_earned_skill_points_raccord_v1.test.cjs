...
assert.equal(indexBuf.length,8170726,'earned-points raccord RED must start from exact preaudit GREEN index');
assert.equal(gitBlob(indexBuf),'d9ee34d47fa888795db68cdc244d0c73d30ee523','earned-points raccord RED index drifted');
