...
export function mountCombatConfigEditor(host,universe,onChange){
  ...
  host.innerHTML=`<section class="editor-section"><div class="section-title-row"><div><h3>Règles de combat</h3><p class="muted">Initiative, règle de KO et jet par défaut sont configurables sans nom imposé.</p></div><button class="help-button tiny" type="button" data-help="rpg-combat-config">?</button></div>
