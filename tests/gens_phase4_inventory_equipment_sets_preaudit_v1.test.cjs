...
const blob=crypto.createHash('sha1')
  ...
  .digest('hex');
assert.equal(bytes.length,8169596,'preaudit must execute the exact verified index');
assert.equal(blob,'d451372389f29d0145d3f9689ca739128a0650e9','preaudit index blob drifted');
