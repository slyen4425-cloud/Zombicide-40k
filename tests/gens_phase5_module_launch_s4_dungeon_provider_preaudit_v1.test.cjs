...
assert.equal(bytes.length,8172118,'S4 preaudit/postaudit must track the current validated runtime');
assert.equal(gitBlob,'198207e3f52730498831f196caa35c4a0283e934','S4 preaudit/postaudit blob must track the current validated runtime');
