...
const blob=crypto.createHash('sha1')
  ...
  .digest('hex');
assert.equal(bytes.length,8170472,'preaudit must execute the exact verified index');
assert.equal(blob,'2232d8c1d65121758646915080bd3c17be4d4cd6','preaudit index blob drifted');
