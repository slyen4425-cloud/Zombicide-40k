...
assert.equal(bytes.length,8170150,'S3 RED must start from the exact S2 GREEN runtime');
assert.equal(gitBlob,'ca5cb0b92f4e6ff8779ebe2339bb2be32a89f8f9','S3 RED must start from the exact S2 GREEN blob');
