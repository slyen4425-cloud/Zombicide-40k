...
assert.equal(indexBuf.length,8171571,'earned-points preaudit must run on exact xpIntoLevel GREEN index');
assert.equal(gitBlob(indexBuf),'6e76a99af5fb839db5ffb20a2e67fd1572bf13ea','earned-points preaudit index blob drifted');
