...
assert.equal(indexBuf.length,8172610,'preaudit must stay aligned to the exact d10048 raccord index');
assert.equal(gitBlob,'eddba424d3ebb086a1bdd0bcc1b1822d16a83771','preaudit index blob drifted');
