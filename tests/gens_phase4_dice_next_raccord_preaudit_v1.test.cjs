...
assert.equal(indexBuf.length,8170961,'preaudit must stay aligned to the exact d10048 raccord index');
assert.equal(gitBlob,'0c15b1dba66ce83f2b27ed99e371885fb1d0ed75','preaudit index blob drifted');
