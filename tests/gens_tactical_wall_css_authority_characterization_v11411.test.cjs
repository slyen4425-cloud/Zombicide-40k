...
assert.deepEqual(debt,['V108','V109'],'CSS wall debt inventory changed: V111/V112/V113 must remain clean; remove remaining modules one at a time');
...
console.log('GenSrpG V114.11 CSS wall debt characterized:',debt.join(', '),'with V111/V112/V113 CSS authority retired and Tactical UI canonical');
