...
assert.equal(indexBuf.length,8173578,'first-raccord preaudit must track the exact connected index after its dedicated raccord');
assert.equal(indexBlob,'9313afd3437fe827b9c17245a675f75645570878','index blob drifted after the dedicated Progression raccord');
