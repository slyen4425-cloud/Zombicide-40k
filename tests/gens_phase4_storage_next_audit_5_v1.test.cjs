...
assert.equal(bytes.length,8172505,'current Phase 5 Shell index byte size drifted');
assert.equal(blob,'c17460335b2deb5e5916dbf91448b0706c38d0df','audit 5 must target the exact post-Deck index blob');
