...
assert.equal(bytes.length,8172529,'Progression preaudit must run on the exact first-raccord index');
assert.equal(blob,'696014056409dda9b6ef25ace58dfd9d5f9e2718','Progression preaudit index blob drifted');
