...
assert.equal(indexBuf.length,8172529,'raccord guard must target current Dungeon S2 runtime size');
assert.equal(gitBlob(indexBuf),'696014056409dda9b6ef25ace58dfd9d5f9e2718',
