...
assert.equal(blob,'bfe9149e8150f15017bfcffe1a00fb797791aa83','asset resolver final audit must target the current post-Challenge-Library runtime index blob');
