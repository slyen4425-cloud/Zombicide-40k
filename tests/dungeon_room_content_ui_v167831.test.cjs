...
assert.match(loader,/dungeon-random-library-content-167832\.js\?v=167833/);assert.match(loader,/dungeon-world-session-bridge-167832\.js\?v=167838/);assert.match(loader,/dungeon-room-content-ui-167831\.js\?v=167833/);
assert.match(sw,/gensrpg-cache-16\.78\.38-built-world-no-auto-generation/);assert.match(sw,/dungeon-room-content-ui-167831\.js/);assert.match(sw,/dungeon-random-library-content-167832\.js/);assert.match(sw,/dungeon-world-session-bridge-167832\.js/);
const htmlArg=process.argv[2];if(htmlArg){const site=path.dirname(path.resolve(htmlArg));for(const f of ['dungeon-room-content-ui-167831.js','dungeon-random-library-content-167832.js','dungeon-world-session-bridge-167832.js'])assert.ok(fs.existsSync(path.join(site,'assets','dungeon',f)),f+' doit être présent dans le site final');const built=fs.readFileSync(path.join(site,'assets','dungeon','dungeon-room-creator-feedback-167821.js'),'utf8');assert.match(built,/dungeon-room-content-ui-167831\.js\?v=167833/);assert.match(built,/dungeon-random-library-content-167832\.js\?v=167833/);assert.match(built,/dungeon-world-session-bridge-167832\.js\?v=167838/)}
console.log('Dungeon intuitive random-library UI V16.78.38 loading: OK');
