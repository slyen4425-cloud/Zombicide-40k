...
assert.equal(runtime.length,8172742,'contract-only lot must keep the manually validated runtime size');
assert.equal(gitBlob(runtime),'95f8c96e7e221eb743f7c8013ffa8af499eca1c8',
