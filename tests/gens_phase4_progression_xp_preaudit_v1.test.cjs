...
assert.equal(bytes.length,8171571,'Progression preaudit must run on the exact first-raccord index');
assert.equal(blob,'6e76a99af5fb839db5ffb20a2e67fd1572bf13ea','Progression preaudit index blob drifted');
