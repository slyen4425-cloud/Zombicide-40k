...
assert.equal(bytes.length,8172500,'current Phase 5 Shell index byte size drifted');
assert.equal(blob,'7b586e9fb14b7a93a0edb069e115fd6d48cbda97','audit 5 must target the exact post-Deck index blob');
