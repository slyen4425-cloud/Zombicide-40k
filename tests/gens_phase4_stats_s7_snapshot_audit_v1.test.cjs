...
assert.equal(bytes.length,8169503,'S7 must audit the exact verified index');
assert.equal(blob,'fb8c77504ed067fb094374260b459f8d1fb7e824','S7 index blob must remain the Rule 26 verified source');
