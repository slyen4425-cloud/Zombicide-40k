...
assert.match(src,/GenSrpG V16\.78\.97/,'cleanup/stability bridge must carry V16.78.97');
...
console.log('GenSrpG V16.78.97 editor cleanup/stability bridge + V16.78.95 stats engine: OK');
