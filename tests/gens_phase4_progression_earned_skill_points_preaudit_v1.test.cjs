...
assert.equal(indexBuf.length,8170961,'earned-points preaudit must run on exact xpIntoLevel GREEN index');
assert.equal(gitBlob(indexBuf),'0c15b1dba66ce83f2b27ed99e371885fb1d0ed75','earned-points preaudit index blob drifted');
