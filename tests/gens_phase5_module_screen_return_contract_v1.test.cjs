...
assert.equal(runtime.length,8169596,'contract-only lot must keep the manually validated runtime size');
assert.equal(gitBlob(runtime),'d451372389f29d0145d3f9689ca739128a0650e9',
