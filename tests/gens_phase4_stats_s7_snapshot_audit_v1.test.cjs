...
assert.equal(bytes.length,8171576,'S7 must audit the exact verified index');
assert.equal(blob,'12be0fdbaa5c05f7852933b48a3dd5df09da6145','S7 index blob must remain the Rule 26 verified source');
