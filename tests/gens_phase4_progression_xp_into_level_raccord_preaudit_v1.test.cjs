...
assert.equal(indexBuf.length,8173578,'raccord preaudit must use exact contract GREEN index');
assert.equal(gitBlob(indexBuf),'9313afd3437fe827b9c17245a675f75645570878','runtime index drifted');
