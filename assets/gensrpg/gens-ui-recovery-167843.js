/* GenSrpG V16.78.43 — UI/PWA recovery guard.
   UI-only recovery remains unchanged. It also bootstraps the isolated exact-trap
   runtime used only by authored Dungeon worlds. */
(function(){
"use strict";
...
ROOT.GenSrpGUiRecovery167843={VERSION,APP_VERSION,STYLE_ID,BUILDER_MODALS,TRAP_SCRIPT_ID,ensureStyle,closeUnexpectedBuilderModals,loadExactTrapRuntime,install};
