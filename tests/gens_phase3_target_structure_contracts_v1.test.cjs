...
assert.equal(Object.keys(ownerManifest.files||{}).length,75,'Phase 3 scaffolding must remain inert while the current Phase 4 production owner graph contains 75 files');
