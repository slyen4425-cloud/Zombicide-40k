...
assert.equal(Object.keys(ownerManifest.files||{}).length,68,'Phase 3 scaffolding must remain inert while the current Phase 4 production owner graph contains 68 files');
