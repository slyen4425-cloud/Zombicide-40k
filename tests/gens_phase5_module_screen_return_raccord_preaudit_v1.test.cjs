...
assert.equal(indexBuf.length,8171854,'raccord guard must target current Dungeon S2 runtime size');
assert.equal(gitBlob(indexBuf),'97f0e060d8bffcde2baaf5aa42c1e16b8544263f',
