...
assert.equal(bytes.length,8172505,'S7 must audit the exact verified index');
assert.equal(blob,'c17460335b2deb5e5916dbf91448b0706c38d0df','S7 index blob must remain the Rule 26 verified source');
