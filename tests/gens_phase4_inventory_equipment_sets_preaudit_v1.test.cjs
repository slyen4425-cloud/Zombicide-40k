...
const blob=crypto.createHash('sha1')
  ...
  .digest('hex');
assert.equal(bytes.length,8170143,'preaudit must execute the exact verified Phase 7 room-kind index');
assert.equal(blob,'23b4f59009c5e51fdb91e9bfe3fd87d2a79bba3d','preaudit Phase 7 room-kind index blob drifted');
