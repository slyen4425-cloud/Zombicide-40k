...
assert.equal(bytes.length,8174649,'current Phase 5 Shell index byte size drifted');
assert.equal(blob,'ef8a0ac77019ed08f166a97389dd5bdf4a692841','audit 5 must target the exact post-Deck index blob');
