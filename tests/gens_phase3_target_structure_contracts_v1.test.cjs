...
assert.equal(Object.keys(ownerManifest.files||{}).length,74,'Phase 3 scaffolding must remain inert while the current Phase 4 production owner graph contains 74 files');
