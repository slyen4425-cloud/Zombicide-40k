...
assert.equal(bytes.length,8172204,'S4 RED must start from the exact S3 GREEN runtime');
assert.equal(gitBlob,'6c95e3f6ca4bf8e34003776e7e43e44192aafb16','S4 RED must start from the exact S3 blob');
