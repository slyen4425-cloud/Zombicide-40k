...
assert.equal(bytes.length,8172204,'current Phase 5 Shell index size must remain deterministic');
assert.equal(gitBlob(bytes),'6c95e3f6ca4bf8e34003776e7e43e44192aafb16','MJ Rules raccord must target the current Phase 5 Shell baseline');
