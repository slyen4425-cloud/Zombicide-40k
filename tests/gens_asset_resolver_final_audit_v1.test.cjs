...
assert.equal(blob,'0b9c41c39db0d073c7b9ed580f66140b8d9bcda2','asset resolver final audit must target the current post-gameplay-by-profile runtime index blob');
