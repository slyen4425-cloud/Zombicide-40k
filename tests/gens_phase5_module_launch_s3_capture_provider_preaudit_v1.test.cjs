...
assert.equal(bytes.length,8172742,'S3 preaudit must start from the exact user-validated S2 runtime');
assert.equal(gitBlob,'95f8c96e7e221eb743f7c8013ffa8af499eca1c8','S3 preaudit must start from the exact S2 blob');
