...
assert.equal(index.length,8174315,'index.html byte size drifted from current Phase 5 Shell baseline');
assert.equal(blobSha,'0aaafb2eaf42b7bce6520efa633b6b6a6ffbe92a','index.html blob must remain the current Phase 5 Shell baseline source');
