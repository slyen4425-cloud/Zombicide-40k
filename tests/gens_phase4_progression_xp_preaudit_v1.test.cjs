...
assert.equal(bytes.length,8171795,'Progression preaudit must run on the exact first-raccord index');
assert.equal(blob,'4f8c3b9be4189a9ac163fcb17531c95cbd783b05','Progression preaudit index blob drifted');
