...
assert.equal(indexBuf.length,8174314,'next-seam preaudit must run on exact first-raccord GREEN index');
assert.equal(gitBlob(indexBuf),'8ef7c65fca1f72f0393f0f6ccb6fea8426b41f91','next-seam preaudit index blob drifted');
