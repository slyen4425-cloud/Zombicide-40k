...
assert.equal(indexBuf.length,8172204,'raccord preaudit must use exact contract GREEN index');
assert.equal(gitBlob(indexBuf),'6c95e3f6ca4bf8e34003776e7e43e44192aafb16','runtime index drifted');
