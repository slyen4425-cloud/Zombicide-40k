...
assert.equal(indexBuf.length,8174637,'preaudit must stay on the exact first-raccord GREEN index');
assert.equal(gitBlob,'5b8e790fefe7970a250fd9485ee80549511737e6','preaudit index blob drifted');
...
console.log(JSON.stringify({scenario:'Phase 4 Core Dice next-raccord preaudit',selection,runtimeChanged:false},null,2));
