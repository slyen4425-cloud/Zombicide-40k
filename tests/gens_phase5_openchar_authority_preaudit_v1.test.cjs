...
assert.equal(bytes.length,8171576,'openChar guard must target the current Core 0.28-retired runtime');
assert.equal(gitBlob(bytes),'12be0fdbaa5c05f7852933b48a3dd5df09da6145',
