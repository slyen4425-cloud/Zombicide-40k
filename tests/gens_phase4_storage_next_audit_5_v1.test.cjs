...
assert.equal(bytes.length,8171854,'repaired Phase 5 Dungeon grid index byte size drifted');
assert.equal(blob,'97f0e060d8bffcde2baaf5aa42c1e16b8544263f','audit 5 must target the exact repaired Dungeon grid index blob');
