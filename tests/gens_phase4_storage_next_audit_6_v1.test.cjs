...
assert.equal(bytes.length,8174314,'audit 6 must target the exact post-Economy-Rules index size');
assert.equal(blob,'8ef7c65fca1f72f0393f0f6ccb6fea8426b41f91','audit 6 must target the exact post-Economy-Rules index blob');
