...
assert.equal(indexBuf.length,8174346,'preaudit must stay aligned to the exact d10048 raccord index');
assert.equal(gitBlob,'8da7afa3c986f29e740eee1748dcc0ec0f8f75bc','preaudit index blob drifted');
