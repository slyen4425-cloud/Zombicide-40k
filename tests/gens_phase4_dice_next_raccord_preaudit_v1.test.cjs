...
assert.equal(indexBuf.length,8172687,'preaudit must stay aligned to the exact d10048 raccord index');
assert.equal(gitBlob,'e56f7b63963d991717e1738c3e5188011276a2b7','preaudit index blob drifted');
