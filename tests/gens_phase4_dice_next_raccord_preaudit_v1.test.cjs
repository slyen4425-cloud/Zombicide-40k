...
assert.equal(indexBuf.length,8171571,'preaudit must stay aligned to the exact d10048 raccord index');
assert.equal(gitBlob,'6e76a99af5fb839db5ffb20a2e67fd1572bf13ea','preaudit index blob drifted');
