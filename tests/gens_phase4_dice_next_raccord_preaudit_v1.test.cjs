...
assert.equal(indexBuf.length,8174416,'preaudit must stay aligned to the exact d10048 raccord index');
assert.equal(gitBlob,'a68bcbaf5d16bdbe2e70cbe0959a421371554fcc','preaudit index blob drifted');
