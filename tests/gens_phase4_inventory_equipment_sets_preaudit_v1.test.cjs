...
const blob=crypto.createHash('sha1')
  ...
  .digest('hex');
assert.equal(bytes.length,8174637,'preaudit must execute the exact verified index');
assert.equal(blob,'5b8e790fefe7970a250fd9485ee80549511737e6','preaudit index blob drifted');
