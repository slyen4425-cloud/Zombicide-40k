...
assert.equal(bytes.length,8174649,'post-raccord index size must match the exact Economy rules micro-diff');
assert.equal(blob,'ef8a0ac77019ed08f166a97389dd5bdf4a692841','post-raccord index blob must match the exact Economy rules micro-diff');
