...
assert.equal(bytes.length,8170961,'current Phase 5 Shell index byte size drifted');
assert.equal(blob,'0c15b1dba66ce83f2b27ed99e371885fb1d0ed75','audit 5 must target the exact post-Deck index blob');
