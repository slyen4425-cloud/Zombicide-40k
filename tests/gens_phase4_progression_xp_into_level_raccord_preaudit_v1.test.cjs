...
assert.equal(indexBuf.length,8172118,'raccord preaudit must use exact contract GREEN index');
assert.equal(gitBlob(indexBuf),'198207e3f52730498831f196caa35c4a0283e934','runtime index drifted');
