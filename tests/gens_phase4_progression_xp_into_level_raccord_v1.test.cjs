...
assert.equal(indexBuf.length,8170402,'raccord RED must start from exact preaudit GREEN index');
assert.equal(gitBlob(indexBuf),'2a7dae75115d83b4edc368c42453a7cb58d0bd73','raccord RED index drifted');
