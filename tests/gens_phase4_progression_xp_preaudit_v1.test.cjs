...
assert.equal(bytes.length,8172500,'Progression preaudit must run on the exact first-raccord index');
assert.equal(blob,'7b586e9fb14b7a93a0edb069e115fd6d48cbda97','Progression preaudit index blob drifted');
