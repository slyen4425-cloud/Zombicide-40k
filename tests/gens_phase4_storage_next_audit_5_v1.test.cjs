...
assert.equal(bytes.length,8172529,'current Phase 5 Shell index byte size drifted');
assert.equal(blob,'696014056409dda9b6ef25ace58dfd9d5f9e2718','audit 5 must target the exact post-Deck index blob');
