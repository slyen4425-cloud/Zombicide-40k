...
assert.equal(bytes.length,8169596,'S4 preaudit/postaudit must track the current validated runtime');
assert.equal(gitBlob,'d451372389f29d0145d3f9689ca739128a0650e9','S4 preaudit/postaudit blob must track the current validated runtime');
