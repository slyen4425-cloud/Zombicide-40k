...
assert.equal(bytes.length,8171079,'Progression preaudit must run on the exact first-raccord index');
assert.equal(blob,'6a9392e667881f2087e4df931645cada4201cb3c','Progression preaudit index blob drifted');
