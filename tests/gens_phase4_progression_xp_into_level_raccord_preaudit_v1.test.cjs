...
assert.equal(indexBuf.length,8174148,'raccord preaudit must use exact contract GREEN index');
assert.equal(gitBlob(indexBuf),'f13835a2827dbfa9e2698cb026d3e732ad62aba4','runtime index drifted');
