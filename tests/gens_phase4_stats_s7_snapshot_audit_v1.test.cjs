...
assert.equal(bytes.length,8174637,'S7 must audit the exact verified index');
assert.equal(blob,'5b8e790fefe7970a250fd9485ee80549511737e6','S7 index blob must remain the Rule 26 verified source');
