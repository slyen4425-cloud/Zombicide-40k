...
assert.equal(indexBuf.length,8174315,'preaudit must stay aligned to the exact d10048 raccord index');
assert.equal(gitBlob,'0aaafb2eaf42b7bce6520efa633b6b6a6ffbe92a','preaudit index blob drifted');
