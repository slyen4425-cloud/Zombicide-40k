...
assert.equal(bytes.length,8171576,'Progression preaudit must run on the exact first-raccord index');
assert.equal(blob,'12be0fdbaa5c05f7852933b48a3dd5df09da6145','Progression preaudit index blob drifted');
