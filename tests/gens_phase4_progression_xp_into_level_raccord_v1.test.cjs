...
assert.equal(indexBuf.length,8169503,'raccord RED must start from exact preaudit GREEN index');
assert.equal(gitBlob(indexBuf),'fb8c77504ed067fb094374260b459f8d1fb7e824','raccord RED index drifted');
