...
assert.equal(indexBuf.length,8169047,'raccord preaudit must use exact contract GREEN index');
assert.equal(gitBlob(indexBuf),'afc271f9e038f77c5c78caa9f4445d0e49eaea5d','runtime index drifted');
