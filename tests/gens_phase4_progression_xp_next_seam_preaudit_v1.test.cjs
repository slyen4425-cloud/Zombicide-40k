...
assert.equal(indexBuf.length,8170730,'next-seam preaudit must run on exact first-raccord GREEN index');
assert.equal(gitBlob(indexBuf),'7663392f163aac32c4c3b918cbce67472856b3b6','next-seam preaudit index blob drifted');
