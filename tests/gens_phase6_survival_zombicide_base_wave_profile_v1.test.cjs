...
assert.equal(bytes.length,8169503,'micro-lot 3 must start from the final GREEN micro-lot 2 index');
assert.equal(blob,'fb8c77504ed067fb094374260b459f8d1fb7e824','micro-lot 3 must target the exact micro-lot 2 runtime');
