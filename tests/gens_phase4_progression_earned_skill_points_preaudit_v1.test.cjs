...
assert.equal(indexBuf.length,8170730,'earned-points preaudit must run on exact xpIntoLevel GREEN index');
assert.equal(gitBlob(indexBuf),'7663392f163aac32c4c3b918cbce67472856b3b6','earned-points preaudit index blob drifted');
