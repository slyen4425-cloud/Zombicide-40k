...
assert.equal(bytes.length,8169047,'S4 preaudit/postaudit must track the current validated runtime');
assert.equal(gitBlob,'afc271f9e038f77c5c78caa9f4445d0e49eaea5d','S4 preaudit/postaudit blob must track the current validated runtime');
