...
assert.equal(bytes.length,8169596,'S7 must audit the exact verified index');
assert.equal(blob,'d451372389f29d0145d3f9689ca739128a0650e9','S7 index blob must remain the Rule 26 verified source');
