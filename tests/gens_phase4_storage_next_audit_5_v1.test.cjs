...
assert.equal(bytes.length,8171795,'current Phase 5 Shell index byte size drifted');
assert.equal(blob,'4f8c3b9be4189a9ac163fcb17531c95cbd783b05','audit 5 must target the exact post-Deck index blob');
