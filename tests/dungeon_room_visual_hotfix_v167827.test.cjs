...
assert.match(loader,/dungeon-room-visual-hotfix-167827\.js\?v=167830/);assert.match(loader,/dungeon-room-visual-config-167826\.js\?v=167830/);assert.match(loader,/dungeon-room-grid-capture-167830\.js\?v=167830/);assert.match(sw,/gensrpg-cache-16\.78\.30-grid-capture/);assert.match(sw,/dungeon-room-visual-config-167826\.js/);assert.match(sw,/dungeon-room-visual-hotfix-167827\.js/);assert.match(sw,/dungeon-room-grid-capture-167830\.js/);
const htmlArg=process.argv[2];if(htmlArg){const site=path.dirname(path.resolve(htmlArg));assert.ok(fs.existsSync(path.join(site,'assets','dungeon','dungeon-room-visual-hotfix-167827.js')));assert.ok(fs.existsSync(path.join(site,'assets','dungeon','dungeon-room-grid-capture-167830.js')));const builtLoader=fs.readFileSync(path.join(site,'assets','dungeon','dungeon-room-creator-feedback-167821.js'),'utf8');assert.match(builtLoader,/dungeon-room-visual-hotfix-167827\.js\?v=167830/);assert.match(builtLoader,/dungeon-room-grid-capture-167830\.js\?v=167830/);assert.doesNotMatch(builtLoader,/new\s+MutationObserver/)}
console.log('Dungeon Room visual hotfix V16.78.30 loading regression: OK');
