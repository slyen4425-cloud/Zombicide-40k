...
assert.equal(indexBuf.length,8172118,'raccord RED must start from exact preaudit GREEN index');
assert.equal(gitBlob(indexBuf),'198207e3f52730498831f196caa35c4a0283e934','raccord RED index drifted');
