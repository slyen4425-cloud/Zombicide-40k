...
assert.equal(indexBuf.length,8170472,'raccord guard must target current Dungeon S2 runtime size');
assert.equal(gitBlob(indexBuf),'2232d8c1d65121758646915080bd3c17be4d4cd6',
