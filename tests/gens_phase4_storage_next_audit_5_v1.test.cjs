...
assert.equal(bytes.length,8171079,'current Phase 5 Shell index byte size drifted');
assert.equal(blob,'6a9392e667881f2087e4df931645cada4201cb3c','audit 5 must target the exact post-Deck index blob');
