/* GenSrpG Dungeon — final authored bootstrap 16.78.50.
...
const VERSION="1.0.1",APP_VERSION="16.78.50";
let installed=false;
...
function ensureExtras(){loadScript("DungeonZoneLinks167846","assets/dungeon/dungeon-zone-links-167846.js?v=167850",()=>{try{ROOT.DungeonZoneLinks167846?.install?.()}catch(e){}});loadScript("DungeonAuthoredCacheGuard167849","assets/dungeon/dungeon-authored-cache-guard-167849.js?v=167849",()=>{try{ROOT.DungeonAuthoredCacheGuard167849?.install?.()}catch(e){}})}
