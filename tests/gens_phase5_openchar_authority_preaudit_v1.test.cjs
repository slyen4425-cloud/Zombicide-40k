...
assert.equal(bytes.length,8170881,'openChar guard must target the current Core 0.28-retired runtime');
assert.equal(gitBlob(bytes),'f6a11fa5c0807debc0c9950cc2caf5356c97cfc8',
