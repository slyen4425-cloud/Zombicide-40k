...
assert.equal(runtime.length,8170881,'contract-only lot must keep the manually validated runtime size');
assert.equal(gitBlob(runtime),'f6a11fa5c0807debc0c9950cc2caf5356c97cfc8',
