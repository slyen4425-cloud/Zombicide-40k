...
assert.equal(blob,'5b9b9ae780f735eadef049afeb10acf0b57441fe','asset resolver final audit must target the current post-Challenge-Library runtime index blob');
