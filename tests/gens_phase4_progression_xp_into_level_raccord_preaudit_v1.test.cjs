...
assert.equal(indexBuf.length,8171854,'raccord preaudit must use exact contract GREEN index');
assert.equal(gitBlob(indexBuf),'97f0e060d8bffcde2baaf5aa42c1e16b8544263f','runtime index drifted');
