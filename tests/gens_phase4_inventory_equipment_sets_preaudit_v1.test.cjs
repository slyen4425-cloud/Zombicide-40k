...
const blob=crypto.createHash('sha1')
  ...
  .digest('hex');
assert.equal(bytes.length,8174148,'preaudit must execute the exact verified index');
assert.equal(blob,'f13835a2827dbfa9e2698cb026d3e732ad62aba4','preaudit index blob drifted');
