...
assert.equal(runtime.length,8172505,'contract-only lot must keep the manually validated runtime size');
assert.equal(gitBlob(runtime),'c17460335b2deb5e5916dbf91448b0706c38d0df',
