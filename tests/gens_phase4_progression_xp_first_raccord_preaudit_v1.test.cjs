...
assert.equal(indexBuf.length,8172529,'first-raccord preaudit must track the exact connected index after its dedicated raccord');
assert.equal(indexBlob,'696014056409dda9b6ef25ace58dfd9d5f9e2718','index blob drifted after the dedicated Progression raccord');
