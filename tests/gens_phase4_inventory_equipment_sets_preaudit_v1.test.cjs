...
const blob=crypto.createHash('sha1')
  ...
  .digest('hex');
assert.equal(bytes.length,8171186,'preaudit must execute the exact verified index');
assert.equal(blob,'c2424bada56517e579ffe65fa147facbb6bf2caf','preaudit index blob drifted');
