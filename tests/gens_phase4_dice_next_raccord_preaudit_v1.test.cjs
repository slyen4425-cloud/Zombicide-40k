...
assert.equal(indexBuf.length,8171879,'preaudit must stay aligned to the exact d10048 raccord index');
assert.equal(gitBlob,'7601760f7a635094d4f687b725a639b5728e93b4','preaudit index blob drifted');
