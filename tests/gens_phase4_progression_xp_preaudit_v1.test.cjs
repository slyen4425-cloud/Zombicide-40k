...
assert.equal(bytes.length,8171186,'Progression preaudit must run on the exact first-raccord index');
assert.equal(blob,'c2424bada56517e579ffe65fa147facbb6bf2caf','Progression preaudit index blob drifted');
