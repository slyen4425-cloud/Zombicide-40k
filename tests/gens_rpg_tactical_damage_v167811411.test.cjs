...
const rt={DungeonCore317:core317(),loadDungeonRpgRules:()=>({armorZeroBlockChance:75})};
...
const rt50={DungeonCore317:core317(),loadDungeonRpgRules:()=>({armorZeroBlockChance:50})};
...
console.log('V16.78.114.11 canonical melee damage + configurable 75/25 armor floor OK');
