...
assert.equal(blob,'1545aba502777d9fb76decdcee90a89c7cf3f971','asset resolver final audit must target the current post-Challenge-Library runtime index blob');
