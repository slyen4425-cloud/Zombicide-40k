...
assert.equal(bytes.length,8172610,'openChar guard must target the current Core 0.28-retired runtime');
assert.equal(gitBlob(bytes),'eddba424d3ebb086a1bdd0bcc1b1822d16a83771',
