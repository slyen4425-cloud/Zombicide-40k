...
assert.equal(bytes.length,8169047,'current Phase 5 grid-repair index size must remain deterministic');
assert.equal(blob,'afc271f9e038f77c5c78caa9f4445d0e49eaea5d','current Phase 5 grid-repair index blob must remain deterministic');
