...
assert.equal(bytes.length,8169596,'micro-lot 4 must start from the final GREEN micro-lot 3 index');
assert.equal(blob,'d451372389f29d0145d3f9689ca739128a0650e9','micro-lot 4 must target the exact final GREEN micro-lot 3 runtime');
