...
assert.equal(bytes.length,8171854,'Progression preaudit must run on the exact first-raccord index');
assert.equal(blob,'97f0e060d8bffcde2baaf5aa42c1e16b8544263f','Progression preaudit index blob drifted');
