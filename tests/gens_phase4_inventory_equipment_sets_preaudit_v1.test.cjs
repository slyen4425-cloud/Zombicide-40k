...
const blob=crypto.createHash('sha1')
  ...
  .digest('hex');
assert.equal(bytes.length,8171079,'preaudit must execute the exact verified index');
assert.equal(blob,'6a9392e667881f2087e4df931645cada4201cb3c','preaudit index blob drifted');
