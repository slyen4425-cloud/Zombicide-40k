...
assert.equal(bytes.length,8174314,'post-Manual-MJ index byte size drifted');
assert.equal(blob,'8ef7c65fca1f72f0393f0f6ccb6fea8426b41f91','audit 5 must target the exact post-Deck index blob');
