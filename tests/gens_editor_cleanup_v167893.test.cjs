...
assert.match(src,/GenSrpG V16\.78\.105/,'cleanup/stability bridge must carry current V16.78.105 layer');
...
console.log('GenSrpG V16.78.105 scoped editor cleanup/stability bridge + V16.78.95 stats engine: OK');
