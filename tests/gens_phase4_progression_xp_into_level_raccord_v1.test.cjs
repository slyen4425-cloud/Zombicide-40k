...
assert.equal(indexBuf.length,8174148,'raccord RED must start from exact preaudit GREEN index');
assert.equal(gitBlob(indexBuf),'f13835a2827dbfa9e2698cb026d3e732ad62aba4','raccord RED index drifted');
