...
assert.equal(bytes.length,8171079,'S7 must audit the exact verified index');
assert.equal(blob,'6a9392e667881f2087e4df931645cada4201cb3c','S7 index blob must remain the Rule 26 verified source');
