...
assert.equal(bytes.length,8169047,'S7 must audit the exact verified index');
assert.equal(blob,'afc271f9e038f77c5c78caa9f4445d0e49eaea5d','S7 index blob must remain the Rule 26 verified source');
