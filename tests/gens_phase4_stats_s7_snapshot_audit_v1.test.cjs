...
assert.equal(bytes.length,8170726,'S7 must audit the exact verified index');
assert.equal(blob,'d9ee34d47fa888795db68cdc244d0c73d30ee523','S7 index blob must remain the Rule 26 verified source');
