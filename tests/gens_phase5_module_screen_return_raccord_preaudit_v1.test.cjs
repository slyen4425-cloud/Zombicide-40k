...
assert.equal(indexBuf.length,8172742,'raccord guard must target current Dungeon S2 runtime size');
assert.equal(gitBlob(indexBuf),'95f8c96e7e221eb743f7c8013ffa8af499eca1c8',
