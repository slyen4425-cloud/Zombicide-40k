...
assert.equal(indexBuf.length,8173578,'next-seam preaudit must run on exact first-raccord GREEN index');
assert.equal(gitBlob(indexBuf),'9313afd3437fe827b9c17245a675f75645570878','next-seam preaudit index blob drifted');
