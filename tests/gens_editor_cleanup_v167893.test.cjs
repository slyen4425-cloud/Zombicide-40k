...
assert.match(src,/GenSrpG V16\.78\.112/,'cleanup/stability bridge must carry current V16.78.112 layer');
...
console.log('GenSrpG V16.78.112 scoped editor cleanup/stability bridge + V16.78.95 stats engine: OK');
