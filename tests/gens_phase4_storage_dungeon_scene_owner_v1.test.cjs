...
assert.equal(bytes.length,8170726);
assert.equal(blob,'d9ee34d47fa888795db68cdc244d0c73d30ee523','Dungeon Scene final index blob must match deterministic micro-diff');
