...
assert.equal(indexBuf.length,8172529,'raccord RED must start from exact preaudit GREEN index');
assert.equal(gitBlob(indexBuf),'696014056409dda9b6ef25ace58dfd9d5f9e2718','raccord RED index drifted');
