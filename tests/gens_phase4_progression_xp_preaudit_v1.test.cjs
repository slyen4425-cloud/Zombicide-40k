...
assert.equal(bytes.length,8174346,'Progression preaudit must run on the exact first-raccord index');
assert.equal(blob,'8da7afa3c986f29e740eee1748dcc0ec0f8f75bc','Progression preaudit index blob drifted');
