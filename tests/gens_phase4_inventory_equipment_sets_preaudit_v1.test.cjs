...
const blob=crypto.createHash('sha1')
  ...
  .digest('hex');
assert.equal(bytes.length,8170726,'preaudit must execute the exact verified index');
assert.equal(blob,'d9ee34d47fa888795db68cdc244d0c73d30ee523','preaudit index blob drifted');
