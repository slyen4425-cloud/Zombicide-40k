...
assert.equal(bytes.length,8171571,'S7 must audit the exact verified index');
assert.equal(blob,'6e76a99af5fb839db5ffb20a2e67fd1572bf13ea','S7 index blob must remain the Rule 26 verified source');
