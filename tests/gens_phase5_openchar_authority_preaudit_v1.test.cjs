...
assert.equal(bytes.length,8170402,'openChar guard must target the current Core 0.28-retired runtime');
assert.equal(gitBlob(bytes),'2a7dae75115d83b4edc368c42453a7cb58d0bd73',
