...
assert.equal(bytes.length,8169503,'micro-lot 5 must start from the final GREEN micro-lot 4 runtime size');
assert.equal(blob,'fb8c77504ed067fb094374260b459f8d1fb7e824','micro-lot 5 must target the exact final GREEN micro-lot 4 runtime');
