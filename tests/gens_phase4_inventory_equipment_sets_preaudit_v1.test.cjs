...
const blob=crypto.createHash('sha1')
  ...
  .digest('hex');
assert.equal(bytes.length,8169503,'preaudit must execute the exact verified index');
assert.equal(blob,'fb8c77504ed067fb094374260b459f8d1fb7e824','preaudit index blob drifted');
