...
assert.equal(index.length,8170726,'index.html byte size drifted from current Phase 5 Shell baseline');
assert.equal(blobSha,'d9ee34d47fa888795db68cdc244d0c73d30ee523','index.html blob must remain the current Phase 5 Shell baseline source');
