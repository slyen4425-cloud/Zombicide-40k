...
assert.equal(bytes.length,8170143,'micro-lot 4 must run on the current Phase 7 Dungeon room-kind index');
assert.equal(blob,'23b4f59009c5e51fdb91e9bfe3fd87d2a79bba3d','micro-lot 4 must target the current Phase 7 room-kind runtime baseline');
