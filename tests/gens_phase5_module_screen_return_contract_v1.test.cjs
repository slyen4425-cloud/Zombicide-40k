...
assert.equal(runtime.length,8169047,'contract-only lot must keep the manually validated runtime size');
assert.equal(gitBlob(runtime),'afc271f9e038f77c5c78caa9f4445d0e49eaea5d',
