/* GenSrpG V16.78.112 — visual repair + low-overhead stability bridge. */
(function(){
"use strict";
...
const BONUS_PERSIST_SRC="assets/gensrpg/gens-equipment-bonus-persistence-1678103.js?v=1678104";
const ENEMY_STATS_SRC="assets/gensrpg/gens-enemy-canonical-stats-1678105.js?v=1678105";
const DETECTION_SRC="assets/gensrpg/gens-canonical-detection-1678107.js?v=1678108";
const DICE_PERF_SRC="assets/gensrpg/gens-dice-performance-1678108.js?v=1678112";
const COMBAT_PERF_SRC="assets/gensrpg/gens-combat-runtime-performance-1678110.js?v=1678110";
const COMBAT_FLOW_SRC="assets/gensrpg/gens-combat-flow-1678111.js?v=1678112";
...
function loadRuntimeBridges(){loadScript(EVENT_FIX_SRC,"der167879",()=>!!R.DungeonEventRuntimeFix167878);loadScript(FINAL_EXIT_SRC,"daf167879",()=>!!R.DungeonAuthoredFinalExit167875);loadScript(EVENT_CELL_SRC,"dae167879",()=>!!R.DungeonAuthoredEventCells167877);loadScript(GRID_RECOVERY_SRC,"dgr1678100",()=>!!R.DungeonGridDisplayRecovery167856);loadScript(HERO_EDITOR_SRC,"ghed1678101",()=>!!R.GensHeroEditorDynamic167897);loadScript(HERO_INGAME_SRC,"ghia1678100",()=>!!R.GensDungeonHeroIngameArt167898);loadScript(SHEET_ART_SRC,"gdss1678100",()=>!!R.GensDungeonSheetArtStability167899);loadScript(STAT_POLICY_SRC,"gsp1678100",()=>!!R.GensStatUpgradePolicy167898);loadScript(UI_CLEANUP_SRC,"gduc1678100",()=>!!R.GensDungeonUiCleanup1678100);loadScript(EQUIPMENT_CLEANUP_SRC,"gesc1678102",()=>!!R.GensEquipmentStatCleanup1678102);loadScript(BONUS_PERSIST_SRC,"gebp1678104",()=>!!R.GensEquipmentBonusPersistence1678103);loadScript(ENEMY_STATS_SRC,"gecs1678105",()=>!!R.GensEnemyCanonicalStats1678105);loadScript(DETECTION_SRC,"gcd1678108",()=>!!R.GensCanonicalDetection1678107);loadScript(COMBAT_PERF_SRC,"gcrp1678110",()=>!!R.GensCombatRuntimePerformance1678110);loadScript(COMBAT_FLOW_SRC,"gcf1678112",()=>!!R.GensCombatFlow1678111&&R.GensCombatFlow1678111.APP_VERSION==="16.78.112");loadScript(DICE_PERF_SRC,"gdp1678112",()=>!!R.GensDicePerformance1678108&&R.GensDicePerformance1678108.APP_VERSION==="16.78.112");return true}
function loadFinalExit(){return loadScript(FINAL_EXIT_SRC,"daf167879",()=>!!R.DungeonAuthoredFinalExit167875)}
function schedule(){if(scheduled)return;scheduled=true;const run=()=>{scheduled=false;try{repair();cleanupLegacyRpgEditor();R.GensDungeonHeroIngameArt167898?.repairBoard?.();R.GensDungeonSheetArtStability167899?.repairSheet?.();R.GensStatUpgradePolicy167898?.decorateGame?.();R.GensStatUpgradePolicy167898?.injectEditor?.();R.GensDungeonUiCleanup1678100?.run?.();R.GensEquipmentStatCleanup1678102?.cleanupLegacyEquipmentUi?.()}catch(e){}};typeof R.requestAnimationFrame==="function"?R.requestAnimationFrame(run):setTimeout(run,0)}
...
function hookAll(){for(const n of ["ensureDungeonHeroes","applyCustomHeroesMulti","loadGame","loadDungeonGame","resumeDungeonGame","renderParticipantSelector","renderMenu","renderHeroes","openChar","openCharacter","openHeroSheet","showHeroSheet","renderCharacterSheet","renderDungeonHeroSheet","renderRpgUniverseEditor","saveRpgUniverseStats","openHeroCreator","hcRenderRpgStatsUsage","openEquipmentEditor"])hook(n);return true}
function install(){repairDefs();hookAll();schedule();loadRuntimeBridges();setTimeout(hookAll,250);setTimeout(()=>{hookAll();loadRuntimeBridges()},1200);return true}
R.GensDungeonHeroArtRepair167874={HERO_ART,FINAL_EXIT_SRC,EVENT_CELL_SRC,EVENT_FIX_SRC,GRID_RECOVERY_SRC,HERO_EDITOR_SRC,HERO_INGAME_SRC,SHEET_ART_SRC,STAT_POLICY_SRC,UI_CLEANUP_SRC,EQUIPMENT_CLEANUP_SRC,BONUS_PERSIST_SRC,ENEMY_STATS_SRC,DETECTION_SRC,DICE_PERF_SRC,COMBAT_PERF_SRC,COMBAT_FLOW_SRC,LEGACY_EDITOR_CONTROL_IDS,forceImg,repairDefs,repairParticipants,repairPicks,repairSheet,repair,cleanupLegacyRpgEditor,loadFinalExit,loadRuntimeBridges,hookAll,install};
