...
function hookAll(){for(const n of ["ensureDungeonHeroes","renderParticipantSelector","renderMenu","renderRpgUniverseEditor","saveRpgUniverseStats","openHeroCreator","hcRenderRpgStatsUsage","openEquipmentEditor"])hook(n);return true}
