...
assert.equal(Object.keys(ownerManifest.files||{}).length,67,'Phase 3 scaffolding must remain inert while the current Phase 4 production owner graph contains 67 files');
