...
assert.equal(bytes.length,8170472,'S3 RED must start from the exact S2 GREEN runtime');
assert.equal(gitBlob,'2232d8c1d65121758646915080bd3c17be4d4cd6','S3 RED must start from the exact S2 GREEN blob');
