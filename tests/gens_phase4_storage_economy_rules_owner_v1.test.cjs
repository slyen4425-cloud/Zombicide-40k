...
assert.equal(bytes.length,8173578,'post-raccord index size must match the exact Economy rules micro-diff');
assert.equal(blob,'9313afd3437fe827b9c17245a675f75645570878','post-raccord index blob must match the exact Economy rules micro-diff');
