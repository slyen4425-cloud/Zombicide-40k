...
assert.equal(indexBuf.length,8172118,'raccord guard must target current Dungeon S2 runtime size');
assert.equal(gitBlob(indexBuf),'198207e3f52730498831f196caa35c4a0283e934',
