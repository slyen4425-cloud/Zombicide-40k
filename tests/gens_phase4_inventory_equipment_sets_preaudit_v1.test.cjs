...
const blob=crypto.createHash('sha1')
  ...
  .digest('hex');
assert.equal(bytes.length,8172610,'preaudit must execute the exact verified index');
assert.equal(blob,'eddba424d3ebb086a1bdd0bcc1b1822d16a83771','preaudit index blob drifted');
