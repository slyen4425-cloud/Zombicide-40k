...
assert.equal(bytes.length,8174148,'current Phase 5 Shell index byte size drifted');
assert.equal(blob,'f13835a2827dbfa9e2698cb026d3e732ad62aba4','audit 5 must target the exact post-Deck index blob');
