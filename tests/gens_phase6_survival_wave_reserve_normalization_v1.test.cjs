...
assert.equal(bytes.length,8170472,'micro-lot 5 must target the exact connected runtime size');
assert.equal(blob,'2232d8c1d65121758646915080bd3c17be4d4cd6','micro-lot 5 must target the exact connected runtime');
