...
assert.equal(bytes.length,8172204,'Progression preaudit must run on the exact first-raccord index');
assert.equal(blob,'6c95e3f6ca4bf8e34003776e7e43e44192aafb16','Progression preaudit index blob drifted');
