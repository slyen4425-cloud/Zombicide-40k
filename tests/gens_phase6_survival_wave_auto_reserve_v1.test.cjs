...
assert.equal(bytes.length,8170350,'micro-lot 4 must run on the current Phase 7 Dungeon generated-advance index');
assert.equal(blob,'e513d23c7a8c7aef9a187202bbcc34ab540e856f','micro-lot 4 must target the current Phase 7 runtime baseline');
