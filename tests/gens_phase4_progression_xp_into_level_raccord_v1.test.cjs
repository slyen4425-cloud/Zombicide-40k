...
assert.equal(indexBuf.length,8171795,'raccord RED must start from exact preaudit GREEN index');
assert.equal(gitBlob(indexBuf),'4f8c3b9be4189a9ac163fcb17531c95cbd783b05','raccord RED index drifted');
