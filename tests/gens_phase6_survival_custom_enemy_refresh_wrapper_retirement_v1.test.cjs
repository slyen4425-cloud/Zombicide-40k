...
assert.equal(bytes.length,8170350,
  'custom-enemy-refresh wrapper lot must run on the current Phase 7 Dungeon generated-advance runtime size');
assert.equal(blob,'e513d23c7a8c7aef9a187202bbcc34ab540e856f',
  'custom-enemy-refresh wrapper lot must target the current Phase 7 runtime baseline');
