...
assert.equal(blob,'7601760f7a635094d4f687b725a639b5728e93b4','asset resolver final audit must target the current post-Challenge-Library runtime index blob');
