...
assert.equal(bytes.length,8174148,'audit 6 must target the current Phase 5 Shell index size');
assert.equal(blob,'f13835a2827dbfa9e2698cb026d3e732ad62aba4','audit 6 must target the exact post-Economy-Rules index blob');
