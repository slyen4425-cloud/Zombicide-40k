...
assert.equal(runtime.length,8172500,'contract-only lot must keep the manually validated runtime size');
assert.equal(gitBlob(runtime),'7b586e9fb14b7a93a0edb069e115fd6d48cbda97',
