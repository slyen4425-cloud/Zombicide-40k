...
assert.equal(bytes.length,8172500,'current index size must include the later Challenge Library micro-diff');
assert.equal(blob,'7b586e9fb14b7a93a0edb069e115fd6d48cbda97','current index blob must include the later Challenge Library micro-diff');
