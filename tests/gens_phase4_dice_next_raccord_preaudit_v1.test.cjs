...
assert.equal(indexBuf.length,8172505,'preaudit must stay aligned to the exact d10048 raccord index');
assert.equal(gitBlob,'c17460335b2deb5e5916dbf91448b0706c38d0df','preaudit index blob drifted');
