...
assert.equal(bytes.length,8170881,'micro-lot 5 must target the exact connected runtime size');
assert.equal(blob,'f6a11fa5c0807debc0c9950cc2caf5356c97cfc8','micro-lot 5 must target the exact connected runtime');
