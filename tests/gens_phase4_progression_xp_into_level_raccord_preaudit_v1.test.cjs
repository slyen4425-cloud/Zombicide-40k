...
assert.equal(indexBuf.length,8172742,'raccord preaudit must use exact contract GREEN index');
assert.equal(gitBlob(indexBuf),'95f8c96e7e221eb743f7c8013ffa8af499eca1c8','runtime index drifted');
