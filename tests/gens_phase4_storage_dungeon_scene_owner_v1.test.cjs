...
assert.equal(bytes.length,8171571);
assert.equal(blob,'6e76a99af5fb839db5ffb20a2e67fd1572bf13ea','Dungeon Scene final index blob must match deterministic micro-diff');
