...
assert.equal(indexBuf.length,8169503,'first-raccord preaudit must track the exact current index after Survival reserve extraction');
assert.equal(indexBlob,'fb8c77504ed067fb094374260b459f8d1fb7e824','index blob drifted after Survival reserve extraction');
