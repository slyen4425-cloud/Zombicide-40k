...
assert.match(src,/GenSrpG V16\.78\.98/,'cleanup/stability bridge must carry V16.78.98');
...
console.log('GenSrpG V16.78.98 editor cleanup/stability bridge + V16.78.95 stats engine: OK');
