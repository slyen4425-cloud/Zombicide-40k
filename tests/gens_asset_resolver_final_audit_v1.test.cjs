...
assert.equal(blob,'30487d09481e11e5883faca1a6e49727d9cecfb6','asset resolver final audit must target the current post-Challenge-Library runtime index blob');
