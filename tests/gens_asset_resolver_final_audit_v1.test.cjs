...
assert.equal(blob,'cacee0bb95d8c046264668c1ccc721fc88bbed2d','asset resolver final audit must target the current post-Challenge-Library runtime index blob');
