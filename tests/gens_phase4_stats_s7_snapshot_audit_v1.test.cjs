...
assert.equal(bytes.length,8170815,'S7 must audit the exact verified index');
assert.equal(blob,'9c762dcb8ad3549cf7175ba9413f925b11f5396c','S7 index blob must remain the Rule 26 verified source');
