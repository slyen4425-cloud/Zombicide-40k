...
const blob=crypto.createHash('sha1')
  ...
  .digest('hex');
assert.equal(bytes.length,8174580,'preaudit must execute the exact verified index');
assert.equal(blob,'5b9b9ae780f735eadef049afeb10acf0b57441fe','preaudit index blob drifted');
