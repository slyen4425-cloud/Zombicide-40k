...
assert.equal(indexBuf.length,8172687,'goMenu boundary guard must use the current final-Shell runtime');
assert.equal(gitBlob(indexBuf),'e56f7b63963d991717e1738c3e5188011276a2b7','goMenu boundary runtime blob drifted');
assert.equal(owners.sourceIndexBlob,'e56f7b63963d991717e1738c3e5188011276a2b7','owner manifest must target current runtime');
