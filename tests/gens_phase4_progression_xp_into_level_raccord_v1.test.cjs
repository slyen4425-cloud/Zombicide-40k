...
assert.equal(indexBuf.length,8174314,'raccord RED must start from exact preaudit GREEN index');
assert.equal(gitBlob(indexBuf),'8ef7c65fca1f72f0393f0f6ccb6fea8426b41f91','raccord RED index drifted');
