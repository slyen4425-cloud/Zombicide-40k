...
assert.equal(indexBuf.length,8172500,'first-raccord preaudit must track the exact connected index after its dedicated raccord');
assert.equal(indexBlob,'7b586e9fb14b7a93a0edb069e115fd6d48cbda97','index blob drifted after the dedicated Progression raccord');
