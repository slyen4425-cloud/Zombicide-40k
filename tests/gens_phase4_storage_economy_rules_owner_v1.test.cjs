...
assert.equal(bytes.length,8169503,'post-raccord index size must match the exact Economy rules micro-diff');
assert.equal(blob,'fb8c77504ed067fb094374260b459f8d1fb7e824','post-raccord index blob must match the exact Economy rules micro-diff');
