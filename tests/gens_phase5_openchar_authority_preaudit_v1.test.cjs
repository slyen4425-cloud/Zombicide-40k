...
assert.equal(bytes.length,8170815,'openChar guard must target the current Core 0.28-retired runtime');
assert.equal(gitBlob(bytes),'9c762dcb8ad3549cf7175ba9413f925b11f5396c',
