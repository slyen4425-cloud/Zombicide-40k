...
assert.equal(indexBuf.length,8174649,'preaudit must stay aligned to the exact d10048 raccord index');
assert.equal(gitBlob,'ef8a0ac77019ed08f166a97389dd5bdf4a692841','preaudit index blob drifted');
