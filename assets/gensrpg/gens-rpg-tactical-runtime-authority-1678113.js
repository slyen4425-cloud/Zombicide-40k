...
(function(root,factory){
  ...
  function install(rt=R){ensureStyle(rt);ensureDetectionHooks(rt);bindBoardClicks(rt);paintWalls(rt);animateDiceOverlay(rt);try{rt.GENS_RPG_TACTICAL_RUNTIME_AUTHORITY_VERSION=APP_VERSION}catch(e){}installed=!!(adapterHooked&&startHooked);return installed}
