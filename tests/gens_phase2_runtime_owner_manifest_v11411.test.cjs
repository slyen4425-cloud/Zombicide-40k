...
assert.equal(reachable.size,67,'production graph size drifted before owner validation');
assert.equal(mapped.size,67,'owner manifest must currently map all 67 production-reachable files');
