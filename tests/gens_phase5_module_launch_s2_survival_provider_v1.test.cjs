...
assert.equal(bytes.length,8170881,'S2 runtime must match the exact Survival-provider candidate');
assert.equal(gitBlob,'f6a11fa5c0807debc0c9950cc2caf5356c97cfc8','S2 runtime blob must match the exact Survival-provider candidate');
