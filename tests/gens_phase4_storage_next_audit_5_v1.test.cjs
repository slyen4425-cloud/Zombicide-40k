...
assert.equal(bytes.length,8173578,'current Phase 5 Shell index byte size drifted');
assert.equal(blob,'9313afd3437fe827b9c17245a675f75645570878','audit 5 must target the exact post-Deck index blob');
