...
assert.equal(bytes.length,8174315,'Progression preaudit must run on the exact first-raccord index');
assert.equal(blob,'0aaafb2eaf42b7bce6520efa633b6b6a6ffbe92a','Progression preaudit index blob drifted');
