/* GenSrpG V16.78.78 — visual repair for built-in Dungeon hero art + stable late runtime bridges.
   Built-in Dungeon heroes always use their official PNG assets. The same always-loaded bridge also
   loads the authored final-exit/event modules and the shared Dungeon event placement fix. */
(function(){
"use strict";
...
const FINAL_EXIT_SRC="assets/dungeon/dungeon-authored-final-exit-167875.js?v=167878";
const EVENT_CELL_SRC="assets/dungeon/dungeon-authored-event-cells-167877.js?v=167878";
const EVENT_FIX_SRC="assets/dungeon/dungeon-event-runtime-fix-167878.js?v=167878";
...
function loadRuntimeBridges(){
  /* Common fix first so applyDungeonTurnEvent is wrapped before an authored tile can fire. */
  loadScript(EVENT_FIX_SRC,"der167878",()=>!!R.DungeonEventRuntimeFix167878);
  loadScript(FINAL_EXIT_SRC,"daf167875",()=>!!R.DungeonAuthoredFinalExit167875);
  loadScript(EVENT_CELL_SRC,"dae167877",()=>!!R.DungeonAuthoredEventCells167877);
  return true;
}
function loadFinalExit(){return loadScript(FINAL_EXIT_SRC,"daf167875",()=>!!R.DungeonAuthoredFinalExit167875)}
...
R.GensDungeonHeroArtRepair167874={HERO_ART,FINAL_EXIT_SRC,EVENT_CELL_SRC,EVENT_FIX_SRC,forceImg,repairDefs,repairParticipants,repairPicks,repairSheet,repair,loadFinalExit,loadRuntimeBridges,install};
