...
assert.equal(indexBuf.length,8174314,'preaudit must stay aligned to the exact d10048 raccord index');
assert.equal(gitBlob,'8ef7c65fca1f72f0393f0f6ccb6fea8426b41f91','preaudit index blob drifted');
