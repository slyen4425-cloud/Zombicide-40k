...
assert.equal(indexBuf.length,8172204,'earned-points raccord RED must start from exact preaudit GREEN index');
assert.equal(gitBlob(indexBuf),'6c95e3f6ca4bf8e34003776e7e43e44192aafb16','earned-points raccord RED index drifted');
