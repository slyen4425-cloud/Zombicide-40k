...
assert.equal(bytes.length,8172500,'S7 must audit the exact verified index');
assert.equal(blob,'7b586e9fb14b7a93a0edb069e115fd6d48cbda97','S7 index blob must remain the Rule 26 verified source');
