...
assert.equal(bytes.length,8171576,'current Phase 5 Shell index byte size drifted');
assert.equal(blob,'12be0fdbaa5c05f7852933b48a3dd5df09da6145','audit 5 must target the exact post-Deck index blob');
