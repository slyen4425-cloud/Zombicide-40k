...
const blob=crypto.createHash('sha1')
  ...
  .digest('hex');
assert.equal(bytes.length,8172505,'preaudit must execute the exact verified index');
assert.equal(blob,'c17460335b2deb5e5916dbf91448b0706c38d0df','preaudit index blob drifted');
