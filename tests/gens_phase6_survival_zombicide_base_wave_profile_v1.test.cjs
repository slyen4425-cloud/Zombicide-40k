...
assert.equal(bytes.length,8170402,'micro-lot 3 must start from the final GREEN micro-lot 2 index');
assert.equal(blob,'2a7dae75115d83b4edc368c42453a7cb58d0bd73','micro-lot 3 must target the exact micro-lot 2 runtime');
