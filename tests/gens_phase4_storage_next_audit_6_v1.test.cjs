...
assert.equal(bytes.length,8171571,'audit 6 must target the current Phase 5 Shell index size');
assert.equal(blob,'6e76a99af5fb839db5ffb20a2e67fd1572bf13ea','audit 6 must target the exact post-Economy-Rules index blob');
