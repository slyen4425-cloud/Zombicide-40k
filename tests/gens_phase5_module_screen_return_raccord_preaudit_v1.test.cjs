...
assert.equal(indexBuf.length,8169047,'raccord guard must target current Dungeon S2 runtime size');
assert.equal(gitBlob(indexBuf),'afc271f9e038f77c5c78caa9f4445d0e49eaea5d',
