...
assert.equal(indexBuf.length,8172500,'raccord RED must start from exact preaudit GREEN index');
assert.equal(gitBlob(indexBuf),'7b586e9fb14b7a93a0edb069e115fd6d48cbda97','raccord RED index drifted');
