...
assert.equal(bytes.length,8171186,'current Phase 5 Shell index byte size drifted');
assert.equal(blob,'c2424bada56517e579ffe65fa147facbb6bf2caf','audit 5 must target the exact post-Deck index blob');
