...
assert.equal(indexBuf.length,8170961,'first-raccord preaudit must track the exact connected index after its dedicated raccord');
assert.equal(indexBlob,'0c15b1dba66ce83f2b27ed99e371885fb1d0ed75','index blob drifted after the dedicated Progression raccord');
