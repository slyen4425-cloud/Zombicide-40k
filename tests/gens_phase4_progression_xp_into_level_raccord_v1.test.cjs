...
assert.equal(indexBuf.length,8172687,'raccord RED must start from exact preaudit GREEN index');
assert.equal(gitBlob(indexBuf),'e56f7b63963d991717e1738c3e5188011276a2b7','raccord RED index drifted');
