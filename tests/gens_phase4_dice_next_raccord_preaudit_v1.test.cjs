...
assert.equal(indexBuf.length,8172529,'preaudit must stay aligned to the exact d10048 raccord index');
assert.equal(gitBlob,'696014056409dda9b6ef25ace58dfd9d5f9e2718','preaudit index blob drifted');
