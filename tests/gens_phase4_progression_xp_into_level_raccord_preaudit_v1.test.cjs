...
assert.equal(indexBuf.length,8171576,'raccord preaudit must use exact contract GREEN index');
assert.equal(gitBlob(indexBuf),'12be0fdbaa5c05f7852933b48a3dd5df09da6145','runtime index drifted');
