...
assert.equal(indexBuf.length,8172742,'preaudit must stay aligned to the exact d10048 raccord index');
assert.equal(gitBlob,'95f8c96e7e221eb743f7c8013ffa8af499eca1c8','preaudit index blob drifted');
