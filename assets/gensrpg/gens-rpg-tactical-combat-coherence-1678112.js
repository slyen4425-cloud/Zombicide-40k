...
(function(root,factory){
  ...
  function install(rt=R){ensureStyle(rt);hookAdapter(rt);hookResultDetails(rt);hookDetection(rt);bindDetail(rt);observe(rt);maintain(rt);scheduleDetection(rt,"install-vision-v112",true);try{rt.GENSRPG_VERSION=APP_VERSION;rt.GENS_RPG_TACTICAL_COHERENCE_VERSION=APP_VERSION}catch(e){}installed=!!(adapterHooked&&resultHooked);return installed}
