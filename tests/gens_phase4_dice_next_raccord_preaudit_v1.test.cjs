...
assert.equal(indexBuf.length,8171795,'preaudit must stay aligned to the exact d10048 raccord index');
assert.equal(gitBlob,'4f8c3b9be4189a9ac163fcb17531c95cbd783b05','preaudit index blob drifted');
