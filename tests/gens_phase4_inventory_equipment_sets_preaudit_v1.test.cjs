...
const blob=crypto.createHash('sha1')
  ...
  .digest('hex');
assert.equal(bytes.length,8172500,'preaudit must execute the exact verified index');
assert.equal(blob,'7b586e9fb14b7a93a0edb069e115fd6d48cbda97','preaudit index blob drifted');
