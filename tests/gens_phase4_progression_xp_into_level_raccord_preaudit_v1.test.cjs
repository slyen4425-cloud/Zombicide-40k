...
assert.equal(indexBuf.length,8170881,'raccord preaudit must use exact contract GREEN index');
assert.equal(gitBlob(indexBuf),'f6a11fa5c0807debc0c9950cc2caf5356c97cfc8','runtime index drifted');
