...
assert.equal(bytes.length,8174648,'post-Manual-MJ index byte size drifted');
assert.equal(blob,'2d7677950f04e9a3290ff0062e157a126123891d','audit 5 must target the exact post-Deck index blob');
