...
assert.equal(bytes.length,8170815,'current Phase 5 grid-repair index size must remain deterministic');
assert.equal(blob,'9c762dcb8ad3549cf7175ba9413f925b11f5396c','current Phase 5 grid-repair index blob must remain deterministic');
