...
assert.equal(bytes.length,8171854,'S3 RED must start from the exact S2 GREEN runtime');
assert.equal(gitBlob,'97f0e060d8bffcde2baaf5aa42c1e16b8544263f','S3 RED must start from the exact S2 GREEN blob');
