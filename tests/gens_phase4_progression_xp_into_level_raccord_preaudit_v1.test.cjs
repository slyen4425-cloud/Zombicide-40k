...
assert.equal(indexBuf.length,8171571,'raccord preaudit must use exact contract GREEN index');
assert.equal(gitBlob(indexBuf),'6e76a99af5fb839db5ffb20a2e67fd1572bf13ea','runtime index drifted');
