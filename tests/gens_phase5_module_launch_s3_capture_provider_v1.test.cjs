...
assert.equal(bytes.length,8172118,'S3 RED must start from the exact S2 GREEN runtime');
assert.equal(gitBlob,'198207e3f52730498831f196caa35c4a0283e934','S3 RED must start from the exact S2 GREEN blob');
