...
assert.equal(bytes.length,8171879,'Progression preaudit must run on the exact first-raccord index');
assert.equal(blob,'cacee0bb95d8c046264668c1ccc721fc88bbed2d','Progression preaudit index blob drifted');
