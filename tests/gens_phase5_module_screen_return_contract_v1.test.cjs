...
assert.equal(runtime.length,8170402,'contract-only lot must keep the manually validated runtime size');
assert.equal(gitBlob(runtime),'2a7dae75115d83b4edc368c42453a7cb58d0bd73',
