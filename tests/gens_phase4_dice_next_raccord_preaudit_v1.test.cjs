...
assert.equal(indexBuf.length,8170350,'preaudit must stay aligned to the exact current Phase 7 Dungeon generated-advance runtime');
assert.equal(gitBlob,'e513d23c7a8c7aef9a187202bbcc34ab540e856f','preaudit Phase 7 index blob drifted');
