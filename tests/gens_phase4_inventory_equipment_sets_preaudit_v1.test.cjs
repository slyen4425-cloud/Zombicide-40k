...
const blob=crypto.createHash('sha1')
  ...
  .digest('hex');
assert.equal(bytes.length,8171571,'preaudit must execute the exact verified index');
assert.equal(blob,'6e76a99af5fb839db5ffb20a2e67fd1572bf13ea','preaudit index blob drifted');
