...
assert.equal(indexBuf.length,8171186,'next-seam preaudit must run on exact first-raccord GREEN index');
assert.equal(gitBlob(indexBuf),'c2424bada56517e579ffe65fa147facbb6bf2caf','next-seam preaudit index blob drifted');
