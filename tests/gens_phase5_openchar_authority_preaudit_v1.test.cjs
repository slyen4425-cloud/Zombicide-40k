...
assert.equal(bytes.length,8172529,'openChar guard must target the current Core 0.28-retired runtime');
assert.equal(gitBlob(bytes),'696014056409dda9b6ef25ace58dfd9d5f9e2718',
