...
assert.equal(bytes.length,8174314,'post-raccord index size must match deterministic Challenge History micro-diff');
assert.equal(blob,'8ef7c65fca1f72f0393f0f6ccb6fea8426b41f91','post-raccord index blob must match deterministic Challenge History micro-diff');
