...
assert.deepEqual(debt,['V108','V109','V111','V112'],'CSS wall debt inventory changed: V113 must remain clean; remove remaining modules one at a time');
...
console.log('GenSrpG V114.11 CSS wall debt characterized:',debt.join(', '),'with V113 CSS authority retired and Tactical UI canonical');
