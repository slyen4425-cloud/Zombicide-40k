...
assert.equal(indexBuf.length,8172118,'first-raccord preaudit must track the exact connected index after its dedicated raccord');
assert.equal(indexBlob,'198207e3f52730498831f196caa35c4a0283e934','index blob drifted after the dedicated Progression raccord');
