...
assert.equal(indexBuf.length,8169503,'raccord preaudit must use exact contract GREEN index');
assert.equal(gitBlob(indexBuf),'fb8c77504ed067fb094374260b459f8d1fb7e824','runtime index drifted');
