...
assert.deepEqual(debt,['V108','V109','V111','V112','V113'],'CSS wall debt inventory changed: clean modules one at a time and update this characterization deliberately');
...
console.log('GenSrpG V114.11 CSS wall debt characterized:',debt.join(', '),'while Tactical UI remains canonical target');
