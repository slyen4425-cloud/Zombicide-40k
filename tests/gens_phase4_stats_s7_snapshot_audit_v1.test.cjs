...
assert.equal(bytes.length,8174314,'S7 must audit the exact verified index');
assert.equal(blob,'8ef7c65fca1f72f0393f0f6ccb6fea8426b41f91','S7 index blob must remain the Rule 26 verified source');
