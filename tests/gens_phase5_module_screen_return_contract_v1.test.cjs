...
assert.equal(runtime.length,8170472,'contract-only lot must keep the manually validated runtime size');
assert.equal(gitBlob(runtime),'2232d8c1d65121758646915080bd3c17be4d4cd6',
