...
assert.equal(indexBuf.length,8172687,'raccord guard must target current Dungeon S2 runtime size');
assert.equal(gitBlob(indexBuf),'e56f7b63963d991717e1738c3e5188011276a2b7',
