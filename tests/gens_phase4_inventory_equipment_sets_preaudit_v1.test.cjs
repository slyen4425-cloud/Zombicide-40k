...
const blob=crypto.createHash('sha1')
  ...
  .digest('hex');
assert.equal(bytes.length,8170881,'preaudit must execute the exact verified index');
assert.equal(blob,'f6a11fa5c0807debc0c9950cc2caf5356c97cfc8','preaudit index blob drifted');
