...
assert.equal(indexBuf.length,8170150,'raccord preaudit must use exact contract GREEN index');
assert.equal(gitBlob(indexBuf),'ca5cb0b92f4e6ff8779ebe2339bb2be32a89f8f9','runtime index drifted');
