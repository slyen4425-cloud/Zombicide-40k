...
assert.equal(indexBuf.length,8171854,'next-seam preaudit must run on exact first-raccord GREEN index');
assert.equal(gitBlob(indexBuf),'97f0e060d8bffcde2baaf5aa42c1e16b8544263f','next-seam preaudit index blob drifted');
