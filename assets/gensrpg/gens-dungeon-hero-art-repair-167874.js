/* GenSrpG V16.78.97 — visual repair + stability bridge.
   Built-in Dungeon heroes keep their official PNG assets. This always-loaded bridge also
   loads authored runtime modules, tactical-grid recovery and the safe dynamic hero editor. */
(function(){
"use strict";
...
const GRID_RECOVERY_SRC="assets/dungeon/dungeon-grid-display-recovery-167856.js?v=167897";
const HERO_EDITOR_SRC="assets/gensrpg/gens-hero-editor-dynamic-167897.js?v=167897";
...
R.GensDungeonHeroArtRepair167874={HERO_ART,FINAL_EXIT_SRC,EVENT_CELL_SRC,EVENT_FIX_SRC,GRID_RECOVERY_SRC,HERO_EDITOR_SRC,LEGACY_EDITOR_CONTROL_IDS,forceImg,repairDefs,repairParticipants,repairPicks,repairSheet,repair,cleanupLegacyRpgEditor,loadFinalExit,loadRuntimeBridges,install};
