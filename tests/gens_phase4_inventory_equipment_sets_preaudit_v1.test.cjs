...
const blob=crypto.createHash('sha1')
  ...
  .digest('hex');
assert.equal(bytes.length,8172742,'preaudit must execute the exact verified index');
assert.equal(blob,'95f8c96e7e221eb743f7c8013ffa8af499eca1c8','preaudit index blob drifted');
