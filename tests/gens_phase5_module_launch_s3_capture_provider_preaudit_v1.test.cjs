...
assert.equal(bytes.length,8170730,'S3 preaudit must start from the exact user-validated S2 runtime');
assert.equal(gitBlob,'7663392f163aac32c4c3b918cbce67472856b3b6','S3 preaudit must start from the exact S2 blob');
