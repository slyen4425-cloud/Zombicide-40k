...
assert.equal(bytes.length,8174148,'S7 must audit the exact verified index');
assert.equal(blob,'f13835a2827dbfa9e2698cb026d3e732ad62aba4','S7 index blob must remain the Rule 26 verified source');
