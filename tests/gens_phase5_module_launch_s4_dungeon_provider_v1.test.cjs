...
assert.equal(bytes.length,8172610,'S4 RED must start from the exact S3 GREEN runtime');
assert.equal(gitBlob,'eddba424d3ebb086a1bdd0bcc1b1822d16a83771','S4 RED must start from the exact S3 blob');
