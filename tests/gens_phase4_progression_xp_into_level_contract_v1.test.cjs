...
assert.equal(indexBuf.length,8172505,'contract lot must stay on exact preaudit GREEN index');
assert.equal(gitBlob(indexBuf),'c17460335b2deb5e5916dbf91448b0706c38d0df','index runtime must remain untouched by pure contract lot');
