...
assert.equal(bytes.length,8173578,'S7 must audit the exact verified index');
assert.equal(blob,'9313afd3437fe827b9c17245a675f75645570878','S7 index blob must remain the Rule 26 verified source');
