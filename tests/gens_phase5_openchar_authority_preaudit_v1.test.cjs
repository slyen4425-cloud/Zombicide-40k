...
assert.equal(bytes.length,8172204,'openChar guard must target the current Core 0.28-retired runtime');
assert.equal(gitBlob(bytes),'6c95e3f6ca4bf8e34003776e7e43e44192aafb16',
