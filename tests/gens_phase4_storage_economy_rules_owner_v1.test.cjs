...
assert.equal(bytes.length,8174315,'post-raccord index size must match the exact Economy rules micro-diff');
assert.equal(blob,'0aaafb2eaf42b7bce6520efa633b6b6a6ffbe92a','post-raccord index blob must match the exact Economy rules micro-diff');
