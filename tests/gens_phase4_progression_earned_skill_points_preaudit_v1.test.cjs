...
assert.equal(indexBuf.length,8169596,'earned-points preaudit must run on exact xpIntoLevel GREEN index');
assert.equal(gitBlob(indexBuf),'d451372389f29d0145d3f9689ca739128a0650e9','earned-points preaudit index blob drifted');
