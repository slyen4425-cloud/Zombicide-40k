...
const blob=crypto.createHash('sha1')
  ...
  .digest('hex');
assert.equal(bytes.length,8170730,'preaudit must execute the exact verified index');
assert.equal(blob,'7663392f163aac32c4c3b918cbce67472856b3b6','preaudit index blob drifted');
