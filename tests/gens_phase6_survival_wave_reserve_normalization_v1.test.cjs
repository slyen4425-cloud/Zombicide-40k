...
assert.equal(bytes.length,8170815,'micro-lot 5 must target the exact connected runtime size');
assert.equal(blob,'9c762dcb8ad3549cf7175ba9413f925b11f5396c','micro-lot 5 must target the exact connected runtime');
