...
const blob=crypto.createHash('sha1')
  ...
  .digest('hex');
assert.equal(bytes.length,8174648,'preaudit must execute the exact verified index');
assert.equal(blob,'2d7677950f04e9a3290ff0062e157a126123891d','preaudit index blob drifted');
