...
assert.equal(bytes.length,8170730,'S7 must audit the exact verified index');
assert.equal(blob,'7663392f163aac32c4c3b918cbce67472856b3b6','S7 index blob must remain the Rule 26 verified source');
