...
assert.equal(bytes.length,8170472,'repaired Phase 5 Dungeon grid index byte size drifted');
assert.equal(blob,'2232d8c1d65121758646915080bd3c17be4d4cd6','audit 5 must target the exact repaired Dungeon grid index blob');
