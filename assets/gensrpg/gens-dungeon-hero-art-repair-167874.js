/* GenSrpG V16.78.89 — visual repair for built-in Dungeon hero art + stable late runtime bridges.
   Built-in Dungeon heroes always use their official PNG assets. The same always-loaded bridge also
   loads authored final-exit/event modules, shared event placement, unified stats, and persistent stat editor actions. */
(function(){
"use strict";
...
const UNIFIED_STATS_SRC="assets/gensrpg/gens-rpg-stats-unified-167885.js?v=167889";
const STAT_ACTIONS_SRC="assets/gensrpg/gens-rpg-stats-editor-actions-167888.js?v=167889";
