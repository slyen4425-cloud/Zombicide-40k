...
assert.equal(indexBuf.length,8172687,'first-raccord preaudit must track the exact connected index after its dedicated raccord');
assert.equal(indexBlob,'e56f7b63963d991717e1738c3e5188011276a2b7','index blob drifted after the dedicated Progression raccord');
