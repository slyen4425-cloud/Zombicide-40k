...
assert.equal(bytes.length,8170472,'S2 runtime must match the exact Survival-provider candidate');
assert.equal(gitBlob,'2232d8c1d65121758646915080bd3c17be4d4cd6','S2 runtime blob must match the exact Survival-provider candidate');
