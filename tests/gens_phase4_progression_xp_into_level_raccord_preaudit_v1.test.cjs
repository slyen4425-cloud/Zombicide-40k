...
assert.equal(indexBuf.length,8174315,'raccord preaudit must use exact contract GREEN index');
assert.equal(gitBlob(indexBuf),'0aaafb2eaf42b7bce6520efa633b6b6a6ffbe92a','runtime index drifted');
